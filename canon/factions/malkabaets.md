...
> *"They call the High Risk Zone a graveyard. We call it the future."*
> — Malkabaets political declaration

| | |
|---|---|
| **Type** | COP internal political movement |
| **Species** | Multi-species (all three factions represented) |
| **Leader** | Senator Doran Kessler ([Human](../species/human.md), MUD) |
| **HQ** | [COP](../institutions/council_of_peace.md) Assembly |
| **Alignment** | Expansionist / reformist |
| **Core Demand** | Abolish HRZ restrictions. Colonize [Iris](../cosmology/iris_zodiac.md) |
...
The Malkabaets present the arithmetic as follows: galactic population has grown 340% since the end of the [Convergence War](../history/convergence_war.md). Habitable space has grown 0%. The COP's solution has been efficiency — better resource management, denser settlements, recycling mandates. The Malkabaets' counter: efficiency is a ceiling. Expansion is a frontier.

> *"You cannot recycle your way out of a population crisis. At some point, you need more space."*
> — Pullaraakenn, Malkabaets economic address

### The Resource Argument

The HRZ is not empty. It is filled with the ruins and resources of civilizations that predate the current galactic order. The [Exile Scavengers](../factions/exile_scavengers.md) already operate there — illegally, dangerously, and profitably. Every artifact they recover proves the HRZ contains wealth. Every scavenger who survives proves it can be navigated.
...
1. **Demographic shift** — continued population pressure converts moderate delegates over time. Projected timeline: 2-3 cycles at current growth rates
2. **Crisis event** — a resource shortage, ecological collapse, or security threat in the Safe Zone that makes the expansionist argument undeniable. This is the scenario the establishment fears: not that the Malkabaets are elected into power, but that events prove them right
...
| **[ECOS](../factions/earth_conscious_ontological_society.md)** | Iris may be a living entity — colonization would be ecological genocide | "If Iris is alive, prove it. If it isn't, stop pretending" |
...
The population pressure is real. The HRZ resources are real. The [Exile Scavengers](../factions/exile_scavengers.md) prove that the HRZ can be navigated and profited from. But the Cataclysm is also real, and the civilizations that once thrived in the HRZ — the builders of [Ka-Marvam](../factions/ka_dara.md), the engineers of the [Living Factories](../factions/living_factories.md), the Lost Civilizations — collapsed. They were better equipped than the current galactic civilization. They still fell.
...
|------|---------|---------|------|
| **Senator Doran Kessler** | [Human](../species/human.md) | MUD | Movement leader — former MRZ colonial administrator, political strategist, public face |
| **Grukk Selo Eko** | [Mierese](../species/mierese.md) | ONI | Senior COP diplomat — ONI-side coalition builder, responsible for cross-faction recruitment |
| **Rallisa 𐎃 Busan Fur'raft** | [Sogmian](../species/sogmian.md) | ONI | Military analyst — HRZ colonization logistics planner, security argument architect |
| **Pullaraakenn** | [Punaab](../species/punaab.md) | ONI | Economist — models the cost of inaction, public speaker on demographic crisis |
| **Crova.doer** | [Ustur](../species/ustur.md) | Ustur | Defected from pacifist bloc — argues the Path demands courage, provides Ustur moral authority |
...
|---------|--------------|
| [Council of Peace](../institutions/council_of_peace.md) | Parent institution — the movement operates within COP democracy, not against it |
| [ECOS](../factions/earth_conscious_ontological_society.md) | Primary ideological opposition — ecological arguments against HRZ colonization |
| [Exile Scavengers](../factions/exile_scavengers.md) | Living proof point — scavenger HRZ survival and profit supports the Malkabaets argument |
| [Ka-dara](../factions/ka_dara.md) | Cautionary example — a lost civilization's collapse validates both the movement's urgency and its opponents' warnings |
| [Living Factories](../factions/living_factories.md) | Unknown variable — HRZ entities whose nature the Malkabaets may not fully understand |
...
- [Exile Scavengers](../factions/exile_scavengers.md) — HRZ proof point
- [ECOS](../factions/earth_conscious_ontological_society.md) — Primary opposition
- [Ka-dara](../factions/ka_dara.md) — Lost civilization cautionary example
- [Living Factories](../factions/living_factories.md) — Unknown HRZ variable

### Cosmology

- [The Cataclysm](../geography/the_cataclysm.md) — The central question the movement challenges
- [Iris](../cosmology/iris_zodiac.md) — The ultimate colonization target
