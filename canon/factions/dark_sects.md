...
> *"I have burned more dark sect cells than I have mentored students. I do not regret this ratio. I regret that it is necessary."*
> — **Mother Caven**, private correspondence

> *"The orthodox sects ask: how can we grow? The dark sects ask: how can we grow faster? The question is the same. Only the cost is different."*
> — Unnamed Elder Order analyst, internal assessment
...
| **Related (Independent)** | [Church of the Dreamer Below](../factions/church_of_the_dreamer_below.md) — Herdus.soul's criminal cult (classified separately due to its distinct non-cultivation methodology) |
| **Parent Species** | [Ustur](../species/ustur.md) |
...
| **Origin** | Founded ~2555 by **Vaeloss.tchr**, a former [Golden Star](../factions/golden_star.md) meditation instructor |
...
| **Status** | Founder Vaeloss.tchr killed ~2589 by [Winter Fist Path](../factions/winter_fist_path.md) strike team. Three cells confirmed active in Medium-Risk Zone sectors |
...
| **Status** | Elder Order's highest-priority dark sect target. Two cells destroyed in the last decade. One confirmed cell operating in the [Summer Sea](../geography/sectors/summer_sea.md) sector |
| **Operating Zones** | Concealed — [Noctual Caverns](../geography/sectors/summer_sea.md) provide ideal concealment |
...
| **Operating Zones** | Galaxy-wide. Cell-based structure mirrors the [Collective Anarchy](../factions/the_collective_anarchy.md)'s decentralized model |
...
| Sect | Role |
|------|------|
| [Golden Star](../factions/golden_star.md) | Theological authority — provides the ethical framework justifying enforcement. Also the source of two major dark sect defectors (Vaeloss → Siphon Choir, and several Children of the Deep Pool converts), making it simultaneously the bulwark against corruption and the institution most vulnerable to it |
| [Winter Fist Path](../factions/winter_fist_path.md) | Strike operations — provides the combat-trained practitioners who execute dark sect elimination raids. The Path's Fracture Test produces warriors specifically capable of operating in the psychologically extreme environments of dark sect confrontation |
| [Still Water Doctrine](../factions/still_water_doctrine.md) | Intelligence analysis — pattern-recognition capabilities make Still Water graduates uniquely suited to detecting dark sect activity. Several classified operations have been designed by Still Water Architects |
| [Living Resonance](../factions/living_resonance.md) | Defensive posture — the classified knowledge the sect holds makes its practitioners potential dark sect targets. Operates under enhanced Elder Order security protocols |
| [Open Palm](../factions/open_palm.md) | Indirect role — the Open Palm's empathic techniques can theoretically detect the emotional signatures of dark sect practitioners. Lirel.eldr has contributed classified assessments of dark sect recruiter psychology |
| [Resonant Forge](../factions/resonant_forge.md) | Containment technology — the Forge designs and manufactures the zero-resonance containment facilities used to imprison captured dark sect practitioners |
...
> *"The dark sects are a symptom. The disease is the Path itself — a system that promises extraordinary power and then demands extraordinary patience. Remove the patience, and you remove the disease. But you also remove the Path. And without the Path, what are we?"*
> — Unnamed Elder Order philosopher, internal debate (sealed)
...
- [Ustur](../factions/ustur.md) — parent species and civilization
- [Golden Star](../factions/golden_star.md) — theological authority; source of Vaeloss.tchr's defection
- [Winter Fist Path](../factions/winter_fist_path.md) — primary strike force for dark sect elimination
- [Still Water Doctrine](../factions/still_water_doctrine.md) — intelligence analysis for dark sect detection
- [Living Resonance](../factions/living_resonance.md) — defensive posture; potential target due to classified knowledge
- [Open Palm](../factions/open_palm.md) — empathic detection capabilities; psychological profiling
- [Resonant Forge](../factions/resonant_forge.md) — containment technology; source of Rithand's initial break
- [Church of the Dreamer Below](../factions/church_of_the_dreamer_below.md) — Herdus.soul's criminal cult (distinct methodology, classified separately)
- [Galia Medical Union](../factions/galia_medical_union.md) — medical care for Hollowed and Dimmed victims
...
- [Summer Sea](../geography/sectors/summer_sea.md) — confirmed dark sect operating zone; Noctual Caverns concealment
- Medium-Risk Zone sectors — primary dark sect sanctuary due to limited Elder Order enforcement
- [Soletud](../geography/sectors/soletud.md) — site of Rithand's temple and the ~2601 Elder Order raid
