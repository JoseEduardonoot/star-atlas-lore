...
- Xianyang Government (parent) — `canon/factions/xyanyang_government.md`
- Gate Garrison (alumni pipeline) — `canon/factions/gate_garrison.md`
- Redam Government (primary client) — `canon/factions/redam_government.md`
- Abyd Government (primary theater) — `canon/factions/abyd_government.md`
- Xianyang-VI sector — `canon/geography/sectors/xianyang.md`
- Never Alone Campaign — `canon/narratives/never_alone_campaign.md`
- History — `canon/meta/master_timeline.md` (est. ~2569)
- Planets — `canon/reference/atlas/planets.md` (Korrath coordination point)
