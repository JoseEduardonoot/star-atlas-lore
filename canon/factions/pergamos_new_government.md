...
> *"We inherited the ledgers of thieves and the loyalty of no one. Building a government from that is not politics — it is archaeology."*
> — **Governor Markus Tessendorf**, inaugural address, ~2623

| | |
|---|---|
| **Type** | COP-installed transitional authority |
| **Species** | [Human](../species/human.md)-majority |
| **Leader** | Governor Markus Tessendorf (COP-appointed) |
| **HQ** | Pergamos-VIII (MRZ-4) |
| **Established** | ~2623 (post-COP intervention) |
| **Predecessor** | [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) / Pergamos Merchant Republic |
| **Coalition** | [Redam Government](../factions/redam_government.md) (regional partner) |
...
Installed by the [Council of Peace](../institutions/council_of_peace.md) after the military intervention of ~2623, the New Government represents the COP's attempt to transform the MRZ's wealthiest and most criminally entangled sector into a legitimate state. The intervention deployed the **Cradle** — the COP's most powerful titan-class vessel, more powerful than all three faction titans combined — against a sector that had no serious military capability. The message was unmistakable: *submit or be annihilated*.
...
Tessendorf's task is impossible. He must rebuild an economy that was 70 years deep in shadow operations, maintain independence from a COP that considers Pergamos a client state, resist a [MUD Synod](../species/human.md) that is executing a soft financial takeover, and deal with the [Shadow Banks](../factions/pergamos_shadow_banks.md) quietly infiltrating the reconstruction from within. He has no army, limited legitimacy, and a population that remembers — accurately — that the COP punished the innocent alongside the guilty.
...
**Pergamos-VIII** was established during the MUD Empire's aggressive expansion into the Medium Risk Zone around **~2426** — the eighth of nine colonies planted as stepping stones toward the galactic core, alongside [Mycenas-V](../factions/mycenas_government.md), [Xianyang-VI](../factions/xyanyang_government.md), [Redam-VII](../factions/redam_government.md), and [Abyd-IX](../factions/abyd_government.md).

From its earliest days, Pergamos was defined by **wealth**. While other colonies focused on military infrastructure (Xianyang), diplomacy (Redam), or resource extraction (Abyd), Pergamos developed as a **financial center** — a sector where status was measured in ledgers, not ranks. When the MRZ colonies broke away from MUD civilization after the [Convergence War](../history/eras_of_star_atlas.md) (~2522), Pergamos did not descend into warlordism or military dictatorship. It became a **merchant republic** (~2529), with governance concentrated in the hands of roughly **forty banking families** who controlled the sector's enormous wealth.
...
Within the merchant republic's legitimate financial ecosystem, a subset of the most powerful families quietly built **parallel infrastructure** — the [Shadow Banks](../factions/pergamos_shadow_banks.md). Starting around ~2542, Pergamos formally began alliances with major MRZ factions, becoming a **harbor for [Jorvik](../factions/jorvik.md), [ECOS](../factions/earth_conscious_ontological_society.md), and other outlaw groups**. By ~2553, Pergamos banks were **financing the warring factions** in the [Abyd-IX](../factions/abyd_government.md) conflict, generating enormous profits from war profiteering.
...
Under the executive leadership of **Volmik Vaor Scarka** (Mierese), the COP launched a coordinated MRZ campaign targeting three objectives: the [Slavers of Frenir](../factions/slavers_of_frenir.md), the Bankers of Pergamos, and the [Jorvik](../factions/jorvik.md) fleet. The "Bankers of Pergamos" were identified as one of the **three pillars** of the [BMAH](../factions/black_market_auction_house.md) criminal network — alongside the slavers and the [Church of the Dreamer Below](../factions/church_of_the_dreamer_below.md).
...
| **[Fimbul BYOS](../factions/fimbul_byos.md) workshops** | Raided for association with Pergamos shadow economy |
...
- **[Mycenas](../factions/mycenas_government.md)** and **[Xianyang](../factions/xyanyang_government.md)** threatened to intervene if COP operations persisted — two coalition members openly defying the galactic peace-keeping body
- **[Xianyang](../geography/sectors/xianyang.md)** specifically threatened to **openly defy the Council resolution** in the aftermath
- **[Redam](../factions/redam_government.md)** and the MUD Faction led diplomatic negotiations that ultimately halted hostilities
- **[Opos.eldr](../institutions/council_of_peace.md)** (Ustur, COP Legal Branch) enacted rulings demanding cessation
- **[Chior.eldr](../geography/sectors/zenith_door.md)** (Zenith Door) vocally opposed the COP's MRZ invasions
- The **[Free Cities of Humanity](../factions/redam_government.md)** (~2623) formed specifically to pressure the COP into accepting a **truce in the Medium Zone**
...
> — **Tessendorf family elder**, post-exile interview
...
| **Appointed by** | [Council of Peace](../institutions/council_of_peace.md) (~2623) |
...
1. **The COP expects obedience** — they installed him and can remove him. Any hint of independence is tolerated only as long as Pergamos remains compliant.

2. **The legitimate families expect justice** — bankers who lost everything for crimes they didn't commit are returning, demanding restoration. Tessendorf must deliver or lose their support.

3. **The [Shadow Banks](../factions/pergamos_shadow_banks.md) keep infiltrating** — the surviving shadow operators are embedding themselves within the legitimate reconstruction. Every new bank that opens might be a front. Every new financial product might be a Ghost Bond with a clean label.

4. **The [MUD Synod](../species/human.md) is executing a hostile acquisition** — and Tessendorf cannot refuse their capital without watching the reconstruction collapse.

> *"The COP broke our bones and told us to walk. The Synod offers a crutch. The price of the crutch is our legs."*
> — **Governor Tessendorf**, private correspondence
...
The pattern mirrors the Synod's operations in [Pavo Passage](../geography/sectors/pavo_passage.md) through the [Meridian Trading Company](../factions/meridian_trading_company.md): arrive as a helpful partner, extend credit, sign contracts, and gradually make the local economy dependent on MUD-aligned infrastructure.
...
|---------|-------------|-------|
| [COP](../institutions/council_of_peace.md) | Installing authority | Military and financial support; ultimate arbiter of Pergamos's political future |
| [Redam Government](../factions/redam_government.md) | Regional partner | Closest diplomatic ally; Redam mediates and stabilizes |
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Exiled predecessor | Shattered but surviving in distributed form; infiltrating reconstruction |
| [MUD / Synod](../species/human.md) | Rising threat | Soft financial takeover via credit, insurance, and trade infrastructure |
| [MTC](../factions/meridian_trading_company.md) | Synod vehicle | MTC-pattern soft capture being replicated on Pergamos |
| [Jorvik](../factions/jorvik.md) | Residual criminal presence | Harbor operations disrupted but not eliminated; shadow elements remain |
| [ECOS](../factions/earth_conscious_ontological_society.md) | Disrupted partner | Agricultural revenue channels through Shadow Banks severed; some ECOS elements still operate |
| [Fimbul BYOS](../factions/fimbul_byos.md) | Collateral damage | BYOS workshops raided during intervention; operations disrupted |
| [Mycenas Government](../factions/mycenas_government.md) | Sympathetic neighbor | Threatened to intervene against COP on Pergamos's behalf |
| [Xianyang Government](../factions/xyanyang_government.md) | Sympathetic neighbor | Threatened to openly defy COP resolution after the offensive |
| [Abyd Government](../factions/abyd_government.md) | Indirect connection | Shadow Banks still finance Abyd warlords (Garrett Trask) from exile |
| [BMAH](../factions/black_market_auction_house.md) | Historical client | "Bankers of Pergamos" were one of BMAH's three pillars |
| [Merchant Princes of Denebula](../factions/merchant_princes_of_denebula.md) | Wary competitors | Both financial powers; both wary of Synod advance |
...
|------|---------|------|--------|
| **Governor Markus Tessendorf** | [Human](../species/human.md) | COP-appointed governor — Pergamos New Government | Active |
| **Trill Yara** | Mierese (Umbyara) | [Hikibashi](../factions/hikibashi.md) operative — executed the Pergamos Incident | Active |
...
> — attributed to a surviving House Aurel member
