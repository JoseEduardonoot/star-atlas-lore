...
> *"The Confluence is our birthright, shadow and form entwined in Iris's eternal embrace. We elevate the fragmented, weaving wholeness from the void."*
> — **Vaul, the Twilight Lord**
...
| **HQ** | Oundhera — Twilight Nebula (near the [Cataclysm](../geography/the_cataclysm.md)) |
| **Origin** | [Convergence War](../history/convergence_war.md) era — evolved from insectoid parasites through host fusion |
| **Culture** | Feudal hierarchy (the "Ebon Hierarchy") inherited from a dying [Sogmian](../species/sogmian.md) colony |
...
|---------|--------------|-------|
| [Human](../species/human.md) | **High** | Emotional complexity provides rich fusion substrate. The most common host species |
| [Sogmian](../species/sogmian.md) | **High** | The original template — Umbral culture derives from Sogmian hosts. Prestigious fusions |
| [Mierese](../species/mierese.md) | **Moderate** | Aquatic neurology creates partial resistance. Fused Mierese gain amplified euler reflexes |
| [Punaab](../species/punaab.md) | **Low-Moderate** | Commercial species — less desirable but functional hosts |
| [Ustur](../species/ustur.md) | **Immune** | Crystalline neural structure and staged consciousness make fusion impossible. The Umbral's most frustrating limitation |
| [Photoli](../species/photoli.md) | **Special case** | No Umbral has truly dominated a full Photoli. One claims otherwise... |
...
**Ancient ruins** scattered across the nebula hint at pre-Cataclysm civilizations, luring faction explorers from ONI, MUD, and the [Iris Academy](../factions/iris_academy.md) into peril. Those who arrive to study the ruins risk becoming unwitting vessels in the Umbral's eternal game.
...
The Umbral gained sentience at scale during the [Convergence War](../history/convergence_war.md). Unaware colonies settled the Twilight Nebula, drawn by its mineral wealth. When war reached the nebula, battles devastated these colonies — and the Umbral opportunistically fused with dying hosts, forming the first families through instinct and chance.
...
|---------|--------------|
| [Sogmian](../species/sogmian.md) Houses | Cultural template — the Court's feudal structure derives from absorbed Sogmian memories. Sogmians are prestigious hosts |
| [Photoli](../species/photoli.md) | The ultimate host — and the ultimate danger. Vaul's "conquest" of a Photoli is actually his subjugation |
| [Ustur](../species/ustur.md) | Immune — the one species the Court cannot parasitize. A source of deep frustration and rare fear |
| Weakened factions | Opportunistic allies — the Court offers enhancements in exchange for host tributes and loyalty |
| [Exile Scavengers](../factions/exile_scavengers.md) | Potential contact — scavenger crews operating near the Twilight Nebula risk Umbral encounter |
| [Gate Garrison](../factions/gate_garrison.md) | Unknown — the Garrison's HRZ patrols may have encountered Umbral without recognizing them |
...
- [Sogmian](../species/sogmian.md) — Cultural template, prestigious hosts
- [Photoli](../species/photoli.md) — Vaul's secret / reversed fusion
- [Ustur](../species/ustur.md) — Immune to Umbral parasitism
- [Human](../species/human.md) — Most common host species
- [Mierese](../species/mierese.md) — Partial resistance, amplified reflexes
