...
| **Lore Name** | Exodus |
| **Faction** | [MUD](../factions/mud.md) — Manus Ultima Divina |
...
> *"Every road in the galaxy leads somewhere. Every road in Exodus leads to the Serene."*
> — Pilgrim's saying
...
> *"The Serene did not land. She is too vast, too sacred, too permanent to touch the ground. Instead, humanity brought the ground to her."*
> — Architect-General Iaro Gotti, on the completion of the Anchorage Ring (~2450)
...
**The Grand Bazaar**: The Synod's visible presence in the Anchorage. A market complex spanning three connected asteroids where MUD's wealthiest trading families maintain permanent storefronts. The Bazaar handles more ATLAS volume per cycle than most MRZ sector economies combined — luxury goods, rare materials, art, technology, and services flow through here. ONI and Ustur merchants are permitted to trade here under Synod-issued licenses.

---

#### 🌍 Eden Garden (P2) — The Living Memory

> *"Earth is not gone. Earth lives in every seed we carried, every tree we planted, every child who breathes the air of a forest grown from soil that once knew rain on a world two hundred light-years away. We could not save our mother. But we brought her heart with us."*
> — From *The Revelation*, Chapter of the Garden
...
The **Earth Seed Vault** — maintained jointly by the Church and Scientia — is the galaxy's most complete repository of pre-Exodus biological heritage. The Church guards it as sacred trust. Scientia manages the genetics. Neither faction trusts the other with sole custody, which is precisely why the arrangement works.
...
> *"What do you store in a world where nothing decays? Everything you cannot afford to lose."*
> — Dr. Selene Siqueira, on the ice giant's preservation properties
...
> *"Sixty-two billion souls live on Solareth. They are not pilgrims, not soldiers, not priests. They are bakers and teachers and children. They are the reason all the rest of it matters."*
> — Speaker Tomas Renn, on the Senate floor
...
**Abyssal Research Station Omega** — a submerged complex anchored to the ocean floor at a depth of 7 kilometers — is the primary facility. Here, Scientia studies the **Neural Coral Compounds** that grow in formations resembling biological neural networks. The compounds exhibit properties consistent with information storage and transmission — in blunter terms, the coral appears to *think*. Whether it is sentient, passive, or some third category that biology has not yet defined remains an open question that Scientia refuses to answer prematurely.
...
> *"I walked the Processional before I could read. My mother carried me. Every MUD child walks the Processional. It is how we learn where we came from and what it cost."*
> — Anonymous MUD citizen, oral history project
...
**The Cathedral of First Landing** marks the site where the first MUD shuttle touched down on a planet in the Galia Expanse — not the most important landing (that honor belongs to the Anchorage docking), but the most symbolic. The Cathedral is smaller than the Cathedral of the Exodus on the Anchorage, but more intimate. Pilgrims consistently report that it *feels* holier.
...
| **Ustur Regency** | Serene Anchorage | Diplomatic Mission — crystalline station architecture |
...
> *"The Church does not merely preach. It builds. Ecclesia is the proof — five worlds forged into the single largest religious infrastructure in the galaxy. Every missionary who walks the MRZ was trained here. Every doctrine that binds a billion souls was written here. Every hymn was first sung under these skies."*
> — High Prelate Cassandra Vael

### Overview

The Ecclesia system is the spiritual engine of MUD. While the Serene system houses the *symbols* of faith — the Serene, the Cathedral, the Holy Family — Ecclesia houses the *machinery*: the seminaries, the doctrinal courts, the missionary fleets, the philanthropic infrastructure that keeps MUD's billion citizens bound to the faith.

High Prelate Cassandra Vael rules from here — not with the absolute authority of the Gottis, but with the pervasive authority of someone who controls what people believe. The Pearce Council maintains a military garrison (the Church cannot defend itself), and Scientia operates a small research contingent. But Ecclesia belongs to the Church.
...
| **Type** | Asteroid Belt |
| **Resources** | **56** ⭐⭐ |
| **Population** | ~120 million (seminarians, clergy, Church administration) |
| **Controlling Authority** | The Church |
| **Key Installations** | Grand Seminary Complex, Doctrinal Courts, Missionary Academy, Church Treasury |

An asteroid belt transformed — like the Anchorage — into a network of connected stations, each serving the Church's educational and administrative needs. The **Grand Seminary Complex** trains approximately 50,000 new priests per year. The **Doctrinal Courts** adjudicate theological disputes with a rigor that would impress any secular judiciary. The **Missionary Academy** prepares clergy for deployment to the MRZ — survival training, xenolinguistics, cultural adaptation, and the kind of pragmatic courage required to preach in places where MUD is not welcome.

The Church Treasury — the financial arm that manages the Church's vast endowments — operates from a secured asteroid whose location within the belt changes on a rotating schedule known only to the High Prelate's inner circle.

---

#### 🌍 Cassandria (P2) — The Prelate's Seat
...
| **Key Installations** | The Prelature (Vael's palace), Inquisitorial Headquarters, Divina Lingua Institute |

The administrative capital of the Church. **The Prelature** — a sprawling complex of white stone and golden domes — is where Cassandra Vael holds court, receives reports from missionaries across the galaxy, and issues the doctrinal pronouncements that shape the faith of a billion souls.

The **Inquisitorial Headquarters** investigates heresy, blasphemy, and theological deviation within MUD's borders. Its jurisdiction is technically limited to Church members, but in a civilization where Church membership is functionally universal, the distinction is academic.
...
| **Controlling Authority** | Church / Pearce Council |
| **Key Installations** | Missionary Fleet Staging Base, Cold Environment Training Facility, Cryogenic Medical Research Station |
...
| **Population** | ~25 million (Church hospitality, pilgrims) |
| **Controlling Authority** | The Church |
| **Key Installations** | The Baptismal Platform, Cathedral of Immersion, Tidal Observatory |

Every MUD citizen is expected to undergo baptism in the waters of Baptisma at least once in their lifetime — an immersion ritual that symbolizes death (leaving Earth) and rebirth (arriving in the Promised Paradise). The **Baptismal Platform** is a floating mega-structure the size of a city, anchored above the planet's deepest trench, where tens of thousands of baptisms are performed daily.
...
| **Population** | ~500,000 (station crew, Church listeners, signal analysts) |
| **Controlling Authority** | The Church |
| **Key Installations** | The Listening Platforms, Tenon Gas Harvesting Rigs, Voice of God Observatory |

A gas giant whose atmospheric storms produce electromagnetic resonances unique in the galaxy. The Church maintains **Listening Platforms** — orbital stations equipped with massive antenna arrays tuned to the planet's emissions — where specially trained clergy listen for patterns they believe are echoes of God Ahr's voice.
...
**Tenon Gas** — harvested from the upper atmosphere — is a critical component in long-range communication systems. The Church's monopoly on Tenon Gas harvesting in this system gives them effective veto power over communication infrastructure upgrades across Exodus — a leverage point they have used subtly but effectively.

---

## The Bastion System (CSS-MUD-CORE-02) — The Iron Shield

> *"We do not train soldiers. We forge them. Bastion takes the raw material — courage, conviction, youth — and burns away everything that cannot survive a war. What remains is the Pearce Council."*
> — Admiral Darius Ashworth

### Overview

The Bastion system is MUD's military-industrial core. Every warship in the Pearce Council fleet was built here. Every officer was trained here. Every strategic plan was conceived, tested, and war-gamed in the simulation chambers buried deep beneath Ashworth Station's bedrock.

Admiral Darius Ashworth commands from the system's primary installation — a fortress that rivals the Anchorage in scale if not in beauty. The Bastion system is not designed to impress. It is designed to *function*.

Four worlds serve the single purpose of making MUD survivable in a hostile galaxy.
...
| **Type** | Asteroid Belt |
| **Resources** | **60** ⭐ |
| **Population** | ~350 million (military personnel, shipyard workers, logistics) |
| **Controlling Authority** | Pearce Council — Admiral Darius Ashworth |
| **Key Installations** | Pearce Council Operational HQ, Ashworth Shipyards, Drydock Complex Alpha, Fleet Academy, Fimbul Sales Office |

The largest military installation in MUD space. The asteroid belt has been engineered into a network of **shipyards, drydocks, ammunition factories, training simulators, and fleet coordination centers** that together constitute the productive heart of the Pearce Council.

**Ashworth Shipyards** build warships — from patrol corvettes to the components of the **Pearce T1 Titan-class**. The shipyards employ over 40 million workers and operate continuously on three rotating shifts. The sound of construction — felt through the station's hull as a constant low vibration — is so pervasive that personnel transferred to quieter postings report difficulty sleeping in the silence.

**Fimbul Industries** maintains a small but strategically important **Sales Office** on Ashworth Station — selling civilian-grade vessels, energy cells, and ship components to the Pearce Council. The relationship is professional and mutually suspicious: the Council buys Fimbul products because they are excellent, and distrusts Fimbul because the same company sells to everyone else, including the pirates the Council is tasked with destroying.

The **Fleet Academy** trains every officer in the Pearce Council's command structure. Admission is competitive; completion is brutal. Approximately 30% of cadets wash out. Those who remain are among the finest military professionals in the galaxy — a claim that even ONI admirals grudgingly acknowledge.
...
| **Type** | Forest |
| **Resources** | 15 ⭐ |
| **Population** | ~5 million (trainees, instructors, support) |
| **Controlling Authority** | Pearce Council |
| **Key Installations** | Ground Forces Academy, Survival Training Zones, Officer Wilderness School |

A densely forested planet used exclusively for ground-forces training. Every Pearce Council infantry officer spends at least six months on Verdania, learning survival, navigation, small-unit tactics, and the humility that comes from being very cold, very tired, and very lost in a forest that does not care about your rank.
...
| **Population** | ~300,000 (researchers, military guards) |
| **Controlling Authority** | Pearce Council / Scientia (joint) |
| **Key Installations** | Advanced Weapons Research Center, Living Metal Testing Facility, Fusion Catalyst Laboratory |

Where military technology is born. Noctis is a classified research world where Scientia's most dangerous experimental projects are conducted under Pearce Council supervision. The arrangement is pragmatic: Scientia has the brains, the Pearce Council has the guns, and neither trusts the other enough to let them work alone.
...
| **Population** | ~15 million (industrial workers, processing crews) |
| **Controlling Authority** | Pearce Council |
| **Key Installations** | Heavy Munitions Manufacturing Complex, Pyroclast Energen Smelters, Diamond Compression Foundries |
...
Working conditions on Vulcanis are among the harshest in Exodus. The Senate has repeatedly attempted to investigate labor practices. The Pearce Council has repeatedly declined to cooperate, citing military classification. The Senate's investigations remain "ongoing" — a euphemism that has lasted forty years.

---

## The Forum System (CSS-MUD-SEC-01) — The People's Voice

> *"They gave us three worlds and told us to govern. They kept five factions and told us we had authority. The Forum system is the Senate's cage — gilded, comfortable, and locked from the outside."*
> — Speaker Tomas Renn

### Overview

The Forum system is the formal seat of MUD's civilian government — the Senate. In theory, this is where laws are debated, budgets are approved, and the voice of the people is heard. In practice, the Forum system is a monument to institutionalized weakness: the Senate governs here because the other factions allow it, and what the Senate governs is increasingly limited to matters the other factions consider unimportant.

Yet the Forum persists — and in its persistence lies a quiet power that the Church, the Pearce Council, and the Synod consistently underestimate. Speaker Tomas Renn has survived four Gotti succession crises not because he is powerful, but because he is *necessary*. Every empire needs a pressure valve. The Forum is MUD's.
...
| **Type** | Volcanic |
| **Resources** | 22 ⭐ |
| **Population** | ~60 million (industrial workers, miners) |
| **Controlling Authority** | Senate (labor governance) |
| **Key Installations** | Industrial Housing Complex, Workers' Assembly Hall, Pyroclast Processing Plants |

Where the working class of Exodus lives. Ignavera's volcanic landscape is harsh but productive — geothermal energy is abundant, and the Processing Plants convert raw volcanic minerals into the everyday materials that civilian life requires. The **Workers' Assembly Hall** — the only democratically elected body in MUD that actually functions as intended — sends delegates to the Senate on Civitas.

---

#### 🌍 Verdana (P3) — The Garden of Law
...
| **Key Installations** | Senate Residences, Law Academy, Diplomatic Retreat |

Residential world for senators, judges, and senior civil servants. Lush forests, temperate climate, gracious estates. The **Law Academy** trains the civilian judiciary — lawyers, judges, advocates — who administer justice in the parts of MUD space the Church and Pearce Council consider beneath their notice.
...
The newest addition to the Forum system's portfolio. Paxara houses the **Exodus Public Data Archive** — the civilian record of MUD's history, distinct from the Church's sacred archives and the Pearce Council's classified intelligence. Census data, property records, birth and death certificates, court transcripts — the unglamorous foundation of governance.

The **Scriptorium of the Lumikir** maintains a small **Liaison Library** here — an outpost of the Ustur archival tradition that exchanges historical data with MUD's civilian record-keepers. The relationship is cordial and productive — the Scriptorium has corrected seventeen significant historical errors in MUD's public records, which the Senate considers helpful and the Church considers impertinent.

---

## The Oasis System (CSS-MUD-SEC-02) — The Market Gate

> *"Money has no faction. Money has no faith. Money goes where money grows. The Synod merely... provides favorable soil."*
> — Attributed to a Synod operative, source unverified
...
Every commercial vessel entering or leaving Exodus passes through Meridia. The **Commodity Exchange** sets pricing for raw materials across the MUD Safe Zone. The **MTC Regional Headquarters** coordinates the Meridian Trading Company's galaxy-spanning operations from here — a deliberate choice that keeps MTC's shadowy activities close to Synod oversight while maintaining sufficient distance from the Serene system's religious politics.

**Punaab merchants** maintain a permanent trading house on Meridia — the largest alien commercial presence in the Exodus sector. ONI-affiliated Punaab traders handle intermediary commerce between MUD and non-human markets, and the Synod values their linguistic skills and commercial networks enough to grant them preferential licensing.
...
> *"Laboris is not glamorous. Laboris is not holy. Laboris is the system that makes breakfast, assembles the furniture, treats the sick, and keeps the lights on. Without Laboris, the Serene would be dark within a week."*
> — Engineering Guild pamphlet
...
The most populated system in the SEC tier. Fabrica is where things are *made* — consumer goods, construction materials, civilian vehicles, processed food, textiles, electronics, and the ten thousand mundane products that a galactic civilization consumes daily.
...
| **Key Installations** | Scientia Geothermal Research Campus, Tufa Studies Annex, Fusion Reactor Prototype Facility |

Scientia's secondary research campus — built inside a volcanic caldera to harness geothermal energy that would cost billions of ATLAS to replicate synthetically. Dr. Selene Siqueira maintains a **Tufa Studies Annex** here — a satellite facility to her primary lab on Bathyria — where recovered Tufa biological samples are analyzed in conditions the Church cannot easily access or interrupt.

The **Fusion Reactor Prototype Facility** tests experimental power systems using locally mined Plasma Containment Minerals. The research has military implications (more powerful ship reactors), civilian implications (cheaper energy for Laboris's factories), and political implications (whoever controls fusion controls the sector's power grid).
...
Exodus's breadbasket. Sylvanis produces the majority of the sector's food — vast agricultural plantations managed by Senate agricultural cooperatives. The work is unglamorous but essential. Without Sylvanis, the Anchorage's 850 million residents go hungry within two weeks.
...
The most recently developed world in Exodus. Terranova serves as the primary settlement destination for new MUD immigrants — citizens relocating from the MRZ, refugees, and the occasional non-human resident granted permanent residency. The planet is still being developed, with new cities under construction and infrastructure projects stretching across three continents.

---

## The Vigil System (CSS-MUD-SEC-04) — The Outer Watch

> *"The Vigil system exists so that every other system in Exodus can sleep at night. Someone has to watch the dark."*
> — Commander Petra Voss, Vigil Station garrison
...
The nerve center of Exodus's early-warning network. **Long-Range Sensor Arrays** monitor every approach vector into the sector. Rapid-response squadrons maintain 24/7 readiness — pilots sleep in their cockpits on rotating 8-hour watches.
...
The Council's secondary training world — specializing in harsh-environment operations. The desert conditions mimic those found across dozens of MRZ conflict zones. Troops who complete Khassar training (nicknamed "Dust Runners") are considered qualified for deployment anywhere in the galaxy.
...
An ice giant repurposed as a signals intelligence station. The planet's electromagnetic environment provides natural shielding against signal interception — making it ideal for receiving and processing classified communications from Pearce Council assets across the galaxy. What the garrison listens for, and what they hear, is information that never leaves the system.
...
| **Ustur Regency** | Serene Anchorage, Paxara | Diplomatic Mission, Scriptorium Liaison Library |
| **GMU** | Solareth, Covenant, Sylvanis | Medical campuses across three systems |
...
| **Fimbul Industries** | Ashworth Station | Sales Office — military vessel procurement |
| **Positive Union** | Sylvanis | Agricultural community cooperative |
| **Collective Anarchy** | Fabrica | Underground press (illegal) |
