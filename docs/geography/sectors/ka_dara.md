...
| **~2117** | Knowledge trade | Strikes a deal with the [Scriptorium of the Lumikir](../../factions/scriptorium_of_the_lumikir.md) — exchanges Ka-raviam technology and relics for resurrection and eternal life knowledge |
...
> — Ingbus, private log (intercepted by Whisper Conclave)

### Trade & Obsession

- Traders who have bartered with Ingbus's **mechanized envoys** report its insatiable desire for **HRZ materials**
- Particular mention of an **elusive plant, foreign to this region of Galia**
- Ingbus offers **vast riches** for this plant and similar materials
- The A.I. is willing to do anything to see the Ka-raviam empire rise once more

> **Canon note**: Ingbus has certainly tested the **gas-to-water vegetation from Summer Sea** in its research. The plant may have helped advance or test hypotheses, but **no conclusive benefit** was achieved from it.
...
- **~2511**: Discovery of the Cataclysm and its unique resources **renews Ingbus's hope** — begins **funding expeditions to the Cataclysm** in pursuit of materials for the resurrection project
- Materials acquired through daring incursions of the **[Gate Garrison](../../factions/gate_garrison.md) group** — though the Gate Garrison was **secretly founded by a Conscient Tufa (~2525)** to prevent anyone from reaching Iris, making their relationship with Ingbus deeply adversarial
- **~2521**: Ingbus discovers a **unique resource** in the Cataclysm which seems to be the **key to resurrecting the Ka-raviam**. After the Convergence War, the **paths to the Cataclysm disappear**, and Ingbus **obsessively tries to find a way back**
...
- **Amara** escaped but later had her Ka-dara memories **completely erased** — possibly by [Panemorfa](../../factions/panemorfa.md). She remembers everything about Jast except Ka-dara
...
|---------|--------------|
| [Anfoil State](../../factions/anfoil_state.md) / Ponel.eldr | Recognized as peer autonomous intelligence — two AIs acknowledging each other |
| [Scriptorium of the Lumikir](../../factions/scriptorium_of_the_lumikir.md) | Knowledge trade (~2117) — exchanged Ka-raviam relics for resurrection research data |
| [Ustur](../../species/ustur.md) | First formal contact (~2433) — tentative relationship. Ustur view Ingbus with intellectual curiosity and deep caution |
| [Graft Research](../../factions/graft_research.md) | Obsessive target — the biotech fungus is the most coveted technology in the Graft network. Ka-dara refuses all contact |
| [Dark Photoli](../../factions/dark_photoli.md) | Secret deal (~2569) — Ingbus supports Dark Photoli's conquest of Iris in exchange for an immortality elixir recipe |
| [Gate Garrison](../../factions/gate_garrison.md) | Adversarial — Gate Garrison (secretly founded by a Conscient Tufa ~2525) works to prevent Ingbus from reaching the Cataclysm |
| [Sons of Patrah](../../factions/sons_of_patrah.md) | Indirect — rescued Ka-dara captives including Lucaria |
| [COP](../../institutions/council_of_peace.md) | Monitoring — COP cannot project force into MRZ-28 but tracks Ingbus's kidnapping reports |
...
- [Tufa](../../species/tufa.md) — Conscient Tufa secretly founded Gate Garrison (~2525) to prevent Ingbus from reaching the Cataclysm/Iris
- [Photoli](../../species/photoli.md) — Dark Photoli deal (~2569); Ka-dara sector connected to Photoli Om's early encounters with the Lumikir

### Factions

- [Anfoil State](../../factions/anfoil_state.md) — Ponel.eldr recognized as peer autonomous intelligence
- [Scriptorium of the Lumikir](../../factions/scriptorium_of_the_lumikir.md) — Knowledge trade (~2117) — Ka-raviam relics for resurrection research
- [Graft Research](../../factions/graft_research.md) — Obsessive target; biotech fungus bounties posted by multiple pseudonyms
- [Dark Photoli](../../factions/dark_photoli.md) — Secret deal (~2569) — Ingbus supports conquest of Iris for immortality elixir recipe
- [Gate Garrison](../../factions/gate_garrison.md) — Adversarial; Garrison actively prevents Ingbus's return to the Cataclysm
- [Sons of Patrah](../../factions/sons_of_patrah.md) — Rescued Ka-dara captives including Lucaria (Sogmian outlaw turned Lantern Bearer)
- [Panemorfa](../../factions/panemorfa.md) — Possibly erased Amara's Ka-dara memories after her escape

### Narratives

- [Never Alone Campaign](../../narratives/never_alone_campaign.md) — Captain Alaister Jast's betrayal, Amara's erased memories, Lucaria's rescue. Confirms Ingbus treats all entrants as potential biological resources

### Geography

- [Soletud](../sectors/soletud.md) — Linked to Ka-dara; both associated with extinct civilizations and pre-Convergence War mysteries
- [Izar Fallen Civilization](../sectors/izar_fallen_civilization.md) — Third ancient civilization, explicitly **distinct** from Ka-raviam and Soletud builders
- [Dream Reach](../sectors/dream_reach.md) — Medicinal flora trade connection; Ingbus seeks exotic biological materials
- [Summer Sea](../sectors/summer_sea.md) — Gas-to-water vegetation tested by Ingbus; no conclusive benefit achieved
- High-Risk Zone / Cataclysm — Source of exotic materials and the unique resurrection resource (~2511)
