...
> *"They built machines that bent gravity itself. Now their grandchildren farm fungus in the dark and pray to lights they cannot build, cannot repair, and cannot explain."*
> — Iris Academy xenoarchaeologist report (classified)
...
The [Dark Photoli](../factions/dark_photoli.md) discovery of **genesium** deposits on Izar's surface (~2588) revealed a previously unknown fact: the ancestral civilization had **access to genesium** — the bizarre biological-mechanical hybrid substance that warps reality. Whether genesium powered their gravitational experiments, was a byproduct, or both remains one of the galaxy's most tantalizing archaeological questions.
...
A [Dark Photoli](../factions/dark_photoli.md) arrived on the surface and discovered genesium deposits. Experimenting with the reality-warping substance, the Dark Photoli spawned **terrible monsters** — genesium-born creatures distinct from and far more dangerous than the existing gravity-mutated surface fauna.
...
The [Nimrod Trackers](../factions/nimrod_trackers.md) have encountered Keeper councils during genesium-spawn hunts in Izar's depths. The *Ironjaw* — a genesium-laced apex predator with an exoskeleton nearly impervious to kinetic rounds — is considered by the Keepers to be a **sacred warning from the ancestors**. Every hunt requires Council permission. The Trackers have learned to respect this — partly from cultural sensitivity, partly because the Keepers control the Gate Locks that provide access to the hunt zones.
...
| **The Chokepoint** | One safe route exists through the system — a favored [Jorvik](../factions/jorvik.md) hunting ground. Pirates lie in wait for vessels seeking safe passage |
...
| **[Exile Scavengers](../factions/exile_scavengers.md)** | Discovered an underground city with active defenses — never penetrated deep enough for contact |
| **[Iris Academy](../factions/iris_academy.md)** | Theorized survivors could exist. No confirmed contact |
| **[Jorvik](../factions/jorvik.md)** | Control the surface safe corridor. No subterranean awareness |
| **[Nimrod Trackers](../factions/nimrod_trackers.md)** | Hunt genesium spawns in the depths — have interacted with Keeper councils for hunt permissions |
| **[Dark Photoli](../factions/dark_photoli.md)** | Created the genesium monsters. Unknown whether they're aware of the underground population |
...
- [Izar-248 Sector](../geography/sectors/izar.md) — Surface state, debris ring, Jorvik chokepoint
- [Izar Fallen Civilization](../geography/sectors/izar_fallen_civilization.md) — Ancestral empire lore
- [Izar Survivors](../geography/sectors/izar_survivors.md) — Underground descent timeline

### Factions

- [Dark Photoli](../factions/dark_photoli.md) — Genesium experiments, Horror creatures
- [Nimrod Trackers](../factions/nimrod_trackers.md) — Ironjaw hunts, Keeper permissions
- [Exile Scavengers](../factions/exile_scavengers.md) — Discovered underground city
- [Jorvik](../factions/jorvik.md) — Surface corridor control

### Institutions

- [Iris Academy](../factions/iris_academy.md) — Theorized survivors
...
- [Named Characters](../meta/named_characters.md) — No named Izarians (civilization lost its own name)
