...
> *"He didn't build a market. He built a church — and the sacrament was greed."*
> — COP historical assessment

The BMAH was born from necessity and opportunism. During the final years of the Convergence War, a war criminal named **Eknok** — species unknown, crimes classified, identity so thoroughly scrubbed from official records that even COP archivists cannot confirm whether the name is real — crash-landed on **[Etira](../geography/worlds/etira.md)**, a forgotten rock in the [Yuldun Waste](../geography/sectors/yuldun_waste.md). Stranded with a cargo hold full of stolen goods and no legitimate market willing to touch them, Eknok did what any desperate criminal would: he built his own market.
...
Within a decade, Eknok had carved a subsurface complex beneath Etira's crust — a honeycomb of auction halls, vault chambers, and secure docking bays hidden under a planet so hostile that no one would search for them there. The location was genius: Etira sat in the [Yuldun Waste](../geography/sectors/yuldun_waste.md), a sector so barren and radiation-scoured that COP patrols avoided it entirely. The planet's atmosphere was lethal without environmental suits. The perfect safe — locked by nature itself.

### The Three Pillars

Eknok established the three foundational principles that still govern the BMAH:

1. **The Auction is Sovereign** — whatever happens at auction is final. No appeals, no refunds, no exceptions. A bid is a contract with the universe
2. **The Territory is Sacred** — no violence within BMAH space. Violators face death. This rule has been enforced against faction generals, pirate captains, and [COP](../institutions/council_of_peace.md) agents alike. The Sacred Territory extends to any space where an auction is actively occurring — a ship, a station, a cleared asteroid, a rented room
3. **Invitation Only** — entry requires a sponsor who is already a member. The sponsor is liable for their recruit's behavior. If your recruit betrays the house, you die alongside them

### The Rise of Herdus.soul (~2577—2624)

The BMAH's most dramatic era began when **Herdus.soul** — a charismatic [Ustur](../species/ustur.md) who had co-founded the [Zenith Door](../geography/sectors/zenith_door.md) outlaw harbor — rose to become the BMAH's Leading Auctioneer. Under Herdus, the organization expanded from a regional curiosity to a galaxy-spanning network with auction cells in every major sector, financial channels threaded through the [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md), and a client list that included beings from every faction and every species.

Herdus was brilliant, paranoid, and secretly insane. While publicly managing auction operations with meticulous precision — he personally authenticated every Black Lot, memorized every major client's bidding patterns, and maintained the most comprehensive inventory of stolen goods in galactic history — he simultaneously founded the [Church of the Dreamer Below](../factions/church_of_the_dreamer_below.md): a cult that used BMAH infrastructure to recruit vulnerable beings and steal their memories through a horrifying ritual process. For nearly fifty years, no one connected the two organizations. The Leading Auctioneer and the Cult Leader were the same Ustur, and the greatest auction ever conducted was the one where Herdus sold the galaxy on the fiction that they were separate.

### The Never Alone Incident (~2624)

> *"Herdus thought he was untouchable. One Punaab with a knife proved him wrong."*
> — ONI post-action report

The BMAH's invincibility ended when **Saand** — a [Punaab](../species/punaab.md) operative embedded within the Church — killed Herdus.soul and exposed the Church's connection to the BMAH. The resulting [COP](../institutions/council_of_peace.md) investigation led to a military strike on [Etira](../geography/worlds/etira.md) that destroyed the BMAH's subsurface headquarters with military-grade atmospheric shielding, scattered its leadership, and exposed decades of financial records.
...
- The [Church of the Dreamer Below](../factions/church_of_the_dreamer_below.md) was declared defunct
- Multiple auction cells across the MRZ were raided simultaneously
- Financial channels through [Pergamos](../factions/pergamos_shadow_banks.md) were frozen — temporarily
...
| **Black Lots** | Items so dangerous that even the BMAH limits their sale — reality-altering artifacts, [Living Factories](../factions/living_factories.md) components, Dreamer-contaminated materials | Invitation within invitation |
...
> *"He left the Jorvik because he was bored of piracy. He joined the BMAH because he was bored of retirement. Now he runs the galaxy's black market because he's bored of everything else. Garonthe doesn't have ambition. He has competence — and competence, in this galaxy, is more dangerous than ambition."*
> — [Jorvik](../factions/jorvik.md) intelligence assessment

Garonthe is a [Sogmian](../species/sogmian.md) — a species known for cognitive endurance, emotional discipline, and an almost mechanical ability to compartmentalize. He served as a Jorvik captain for decades, running smuggling operations through the MRZ with the kind of quiet efficiency that earns respect rather than fame. He never sought the Pirate King's inner circle. He never broke the Creed. He simply did his job — moving cargo, managing crews, staying alive — until one day he decided he had done enough.
...
|------|---------|------|-------|
| **Garonthe** | [Sogmian](../species/sogmian.md) | Leading Auctioneer — current head | Retired Jorvik captain; assumed control post-Never Alone; maintains Jorvik logistics connections |
| **Herdus.soul** | [Ustur](../species/ustur.md) | Former Leading Auctioneer | Co-founder of [Zenith Door](../geography/sectors/zenith_door.md); secretly founded the [Church of the Dreamer Below](../factions/church_of_the_dreamer_below.md); killed ~2624 by Saand |
| **Eknok** | Unknown | BMAH founder | War criminal; species classified; built the first auction on [Etira](../geography/worlds/etira.md) ~2515; presumed dead |
| **Saand** | [Punaab](../species/punaab.md) | Saboteur | Infiltrated the Church, killed Herdus, triggered the COP raids; status unknown |
| **Drenna Voss** | [Human](../species/human.md) | Senior Auctioneer | Artifact authentication specialist; survived the Never Alone purge |
| **Quiet Jeel** | [Mierese](../species/mierese.md) | Logistics Coordinator | Manages the mobile auction schedule; the only person who knows the full calendar; her death would paralyze operations |
...
|---------|--------------|
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Financial partner — launders auction revenue through layered shell accounts. The BMAH's financial backbone |
| [Jorvik](../factions/jorvik.md) | Operational ally — Garonthe's origin faction provides smuggling logistics, crew recruitment, and client referrals |
| [Sorkof Pirates](../factions/sorkof_pirates.md) | Client — fences plundered goods and buys through the slave pipeline |
| [Panemorfa](../factions/panemorfa.md) | Premium client — covert acquisition of art, cultural treasures, and aesthetic rarities from [Denebula Utopia](../geography/sectors/denebula_utopia.md) |
| [Hopla Insurances](../factions/hopla_insurances.md) | Quiet client — ethic-agnostic doctrine at its purest. They insure what they insure |
| [Relic Barons](../factions/relic_barons.md) | Major client — archaeological finds of dubious provenance are sold, authenticated, and resold through BMAH channels |
| [Church of the Dreamer Below](../factions/church_of_the_dreamer_below.md) | Severed — publicly disavowed after Never Alone. Herdus's cult is an embarrassment that Garonthe has worked to erase from institutional memory |
| [COP](../institutions/council_of_peace.md) | Primary enemy — destroyed [Etira](../geography/worlds/etira.md), ongoing manhunt for senior leadership. Yet certain COP intelligence agencies quietly use BMAH channels for off-books procurement |
| [ONI](../factions/oni.md) | Hostile — the Du Prah monitors BMAH operations for intelligence value but considers the organization morally irredeemable |
| [Order of Seasons](../factions/order_of_seasons.md) | Suspected ties through [Okuto](../geography/worlds/okuto.md)'s Quiet Auction — an invite-only event that may be a BMAH instrument |
| [Gate Garrison](../factions/gate_garrison.md) | Adversarial — bounties issued on known BMAH operatives, though enforcement is inconsistent |
| [Living Factories](../factions/living_factories.md) | Source of Black Lot inventory — Living Factories components are among the most dangerous and valuable items the BMAH handles |
| [Dark Photoli](../factions/dark_photoli.md) | Post-Never Alone concern — Dark Photoli Bah looted the Dreamer's corpse on Etira. What they took is unknown. What it's worth at auction is incalculable |
...
- **The Okuto Connection**: The Quiet Auction on [Okuto](../geography/worlds/okuto.md) — a rotating, invite-only sale for rare parts and "unlisted" items — may be a BMAH satellite operation disguised as a local market. If true, the BMAH has a permanent physical presence in the [Pavo Passage](../geography/sectors/pavo_passage.md) economy despite claiming to operate entirely on mobile platforms. The [Order of Seasons](../factions/order_of_seasons.md) denies involvement. Nobody believes them.
...
- [Sogmian](../species/sogmian.md) — Garonthe (Leading Auctioneer)
- [Ustur](../species/ustur.md) — Herdus.soul (former leader)
- [Punaab](../species/punaab.md) — Saand (saboteur)
- [Human](../species/human.md) — Drenna Voss (Senior Auctioneer)
- [Mierese](../species/mierese.md) — Quiet Jeel (logistics coordinator)

### Geography

- [Etira](../geography/worlds/etira.md) — Former BMAH capital; subsurface auction complex destroyed during Never Alone
- [Yuldun Waste](../geography/sectors/yuldun_waste.md) — Host sector for Etira
- [Zenith Door](../geography/sectors/zenith_door.md) — Herdus.soul's original outlaw harbor
- [Okuto](../geography/worlds/okuto.md) — Suspected BMAH satellite presence via the Quiet Auction
- [Pavo Passage](../geography/sectors/pavo_passage.md) — Trade corridor accessed through Okuto intermediaries
...
- [faction_power_classification.md](../meta/faction_power_classification.md) — T2: Galactic Criminal Network
- [named_characters.md](../meta/named_characters.md) — 7 named BMAH-affiliated characters
