...
> *"Where Redam negotiates, Xianyang enforces. It is not a contradiction — it is a division of labor."*
> — Attributed to a Redam diplomat

| | |
|---|---|
| **Type** | Military dictatorship / [Redam](../factions/redam_government.md) coalition member |
| **Species** | [Human](../species/human.md)-majority (ex-MUD colony) |
| **Leader** | Unknown (military-influenced governance) |
| **HQ** | Xianyang-VI (MRZ-5) |
| **Key Asset** | [Xianyang Enforcers](../factions/xianyang_enforcers.md) — galactic mercenary legion + [Gate Garrison](../factions/gate_garrison.md) alliance |
...
**Xianyang-VI** is the sword of the [Free Cities of Humanity](../factions/redam_government.md). Where [Redam](../factions/redam_government.md) builds bridges, [Mycenas](../factions/mycenas_government.md) raises shields, and [Pergamos](../factions/pergamos_new_government.md) counts credits, Xianyang trains soldiers.
...
**Xianyang-VI** was established during the MUD Empire's expansion into the Medium Risk Zone around **~2426** — the sixth of nine colonies, alongside [Mycenas-V](../factions/mycenas_government.md), [Redam-VII](../factions/redam_government.md), [Pergamos-VIII](../factions/pergamos_new_government.md), and [Abyd-IX](../factions/abyd_government.md).
...
When the [Convergence War](../history/eras_of_star_atlas.md) shattered the galactic order and The Accord (~2523) ended hostilities, all five MUD ex-colonies in the Medium Risk Zone — **Redam, Mycenas, Xianyang, Pergamos, and Abyd** — broke away from MUD civilization.
...
Despite the military pivot, Xianyang was nearly overwhelmed. The 2540s brought a surge of alien invaders — the same forces that terrorized [Mycenas](../factions/mycenas_government.md) during The Horror and ravaged territories across the MRZ. Xianyang's home-grown military, though disciplined, lacked the technology and combat doctrine to handle HRZ-level threats.
...
The turning point came in **~2547**, when Xianyang-VI — after being **nearly overwhelmed by alien invaders** — forged a pivotal alliance with the **[Gate Garrison](../factions/gate_garrison.md)**.
...
The Gate Garrison was a formidable **bounty-hunter collective** from the High Risk Zone — human-founded but accepting all species. Its warriors were among the best-trained in the galaxy, forged in the most dangerous environment known to civilization. Its leader, **[Stommtharic](../factions/gate_garrison.md)** — an Awakened Tufa who had stayed behind after the Cataclysm was sealed — had spent decades watching the HRZ from within.
...
The alliance's ultimate product was the **[Xianyang Enforcers](../factions/xianyang_enforcers.md)** — Xianyang's own mercenary legion, modeled on Gate Garrison methodology and led by **Executor Rhenn Kyung**, a 30-year Garrison veteran.
...
| **Primary Client** | [Free Cities of Humanity](../factions/redam_government.md) — deployed "when diplomacy fails" |
| **Primary Theater** | [Abyd](../factions/abyd_government.md) — pacification operations |
...
The relationship between Xianyang and the [Gate Garrison](../factions/gate_garrison.md) is the most important military alliance in the MRZ.
...
1. **Rite of Passage** graduates enter the Enforcers
2. Top performers are selected for **Gate Garrison training**
3. Garrison-trained operators either stay in the Garrison or return to the Enforcers as **elite officers**
4. Veterans from both organizations retire into the **alumni mercenary network**
5. The network provides **intelligence and contracts** that finance the whole system
...
|---------|-------------|-------|
| [Redam Government](../factions/redam_government.md) | Coalition partner — military arm | Xianyang provides enforcement when diplomacy fails; Redam provides political legitimacy |
| [Gate Garrison](../factions/gate_garrison.md) | Strategic alliance — HQ hosted | The defining relationship — Garrison embedded in Xianyang's military since ~2547 |
| [Mycenas Government](../factions/mycenas_government.md) | Fellow coalition member | Mutual respect — different approaches to the same problem (Mycenas shields, Xianyang fights) |
| [Abyd Government](../factions/abyd_government.md) | Pacification theater | Primary deployment zone for Enforcers — trying to impose order on warlord anarchy |
| [Pergamos New Government](../factions/pergamos_new_government.md) | Sympathetic neighbor | Threatened to openly defy COP resolution after the Pergamos offensive |
| [COP](../institutions/council_of_peace.md) | **Antagonistic** | Xianyang views the COP with open hostility — willing to defy Council resolutions |
| [MUD / Synod](../species/human.md) | Hostile | Shares the ex-colony hostility toward MUD, though less visceral than Mycenas |
| [Xianyang Enforcers](../factions/xianyang_enforcers.md) | Military arm | The output of Xianyang's war economy — mercenary legion fighting across Galia |
...
|------|---------|------|--------|
| **Supreme Marshal Qian Weiming** | [Human](../species/human.md) (MUD) | Head of state — architect of the Rite of Passage, doctrine of "permanent readiness" | Active |
| **Marshal Sable Torren** | [Human](../species/human.md) (MUD) | Marshal of Arms — built Xianyang's war economy, controls all shipyards | Active |
| **Marshal Lanka Dreikh** | [Human](../species/human.md) (MUD) | Marshal of Doctrine — oversees training standards, Gate Garrison liaison | Active |
| **Military Advocate Yun Hessara** | [Human](../species/human.md) (MUD) | De facto foreign minister — the council's voice to the coalition and foreign powers | Active |
| **Executor Rhenn Kyung** | [Human](../species/human.md) (MUD) | Commander of the Xianyang Enforcers — 30-year Gate Garrison veteran | Active |
| **Thresh** | [Human](../species/human.md) (MUD) | Platinum-rank Gate Garrison operative, former Xianyang Enforcer — runs Drift Bastion resupply | Active |
