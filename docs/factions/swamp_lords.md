...
> *"The Mierese of Neuno look to the stars and call themselves civilized. We looked at the swamp and called it home."*
> — Swamp Lords proverb

| | |
|---|---|
| **Type** | Territorial warlords / Mierese separatists / religious guardians |
| **Species** | [Mierese](../species/mierese.md) (early emigrants from [Neuno](../geography/sectors/neuno.md)) |
| **Leader** | The Clans Council — assembly of four tribal chiefs |
| **HQ** | [Glowhaven](../geography/sectors/glowhaven.md) (MRZ-31) |
...
The **Swamp Lords** are a separatist group of [Mierese](../species/mierese.md) who departed their homeworld [Neuno](../geography/sectors/neuno.md) in the early days of Mierese spacefaring. While most of the species embraced the broader galactic community and joined the [ONI](../factions/oni.md), these dissidents saw the uplift as the beginning of cultural dilution. They settled in [Glowhaven](../geography/sectors/glowhaven.md) (MRZ-31) — a wild, bioluminescent frontier — and carved territorial domains across its planets.

They do not recognize the Mierese/ONI government. They are not ONI. They negotiate as a fully autonomous power, or not at all. One thing they kept: their faith in **[Onato](../species/mierese.md)** and their reverence for the [Lore Keepers](../factions/mierese_lore_keepers.md). While they rejected politics, they never abandoned the Mierese religion.
...
The Gulch Maw is so dangerous that even the Swamp Lords — the galaxy's most feared jungle fighters — occasionally hire the [Nimrod Trackers](../factions/nimrod_trackers.md) when their own warriors cannot handle a threat. Warden **Vothara 𐎃 Exinade** led six Trackers into a Gulch Maw tunnel network — twelve days underground, two killed. Vothara triggered a controlled collapse, burying the creature under two hundred meters of rock. The Swamp Lord clan named her an **honorary clan-sister** — the only outsider ever given the title.
...
| **4. The Intensification** | ~2513 | As the [Convergence War](../history/convergence_war.md) rages, the dreams grow more intense. The [Lore Keepers](../factions/mierese_lore_keepers.md) reunite in the sector to understand collectively. Despite combined wisdom: **no answer found** |
...
|---------|---------------|----------|
| **[Iris Academy](../factions/iris_academy.md)** | Study the artifact from Anchorage outpost | Tolerated under strict conditions — science-faith partnership |
| **[Mierese Lore Keepers](../factions/mierese_lore_keepers.md)** | Sacred custodianship | Negotiated — spiritual authority respected, never subordinate |
| **[ONI](../factions/oni.md)** | Political access | Flatly rejected |
| **[COP](../institutions/council_of_peace.md)** | Sector stability | Ignored or threatened |

### The Anchorage Partnership

The [Iris Academy](../factions/iris_academy.md) established its research outpost **Anchorage** (~2595) in Glowhaven specifically to decipher the artifact site. Tension exists between the Academy and the [Lore Keepers](../factions/mierese_lore_keepers.md) — science vs. faith. However, the Lore Keepers **want help opening the box** and are willing to compromise.
...
| **Warden Vothara 𐎃 Exinade** | — (Honorary) | [Nimrod Tracker](../factions/nimrod_trackers.md) — the only outsider ever named honorary clan-sister |
...
|---------|--------------|
| [Mierese Lore Keepers](../factions/mierese_lore_keepers.md) | Spiritual authority respected — the only Mierese institution the Lords recognize |
| [Iris Academy](../factions/iris_academy.md) | Tolerated at arm's length — Anchorage outpost under strict conditions |
| [Nimrod Trackers](../factions/nimrod_trackers.md) | High-value client — Glowhaven mega-fauna contracts. Vothara named honorary clan-sister |
| [ONI](../factions/oni.md) | Shared heritage rejected. Trade when necessary, submit never |
| [COP](../institutions/council_of_peace.md) | COP patrols do not enter Glowhaven without permission |
...
- [Mierese](../species/mierese.md) — Origin species, Onato mythology, Dream Arc
- [Punaab](../species/punaab.md) — Dying World Incident in MRZ-31

### Geography

- [Glowhaven](../geography/sectors/glowhaven.md) — MRZ-31 sector file (primary canon source)
- [Neuno](../geography/sectors/neuno.md) — Mierese homeworld (rejected)

### Factions

- [Mierese Lore Keepers](../factions/mierese_lore_keepers.md) — Spiritual authority, Onato custodianship
- [Iris Academy](../factions/iris_academy.md) — Anchorage, Box research
- [Nimrod Trackers](../factions/nimrod_trackers.md) — Mega-fauna contracts, Vothara honorary clan-sister

### Cosmology

- [Iris Zodiac](../cosmology/iris_zodiac.md) — Dreamer archetype connection

### Meta

- [Named Characters](../meta/named_characters.md) — Four clan chiefs
