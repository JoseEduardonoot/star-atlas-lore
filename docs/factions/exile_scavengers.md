...
> *"The dead leave the best loot. And in Galia, the dead leave entire sectors."*
> — Exile Scavenger motto
...
| **Primary Site** | [Akalma Exile](../geography/sectors/akalma_exile.md) (MRZ-12) — Sogmian devastation zone |
...
When **Bekalu** marshaled the Sogmian armada — with the titan ship **"The Last Stand"** at the vanguard — and devastated the entire [Akalma Exile](../geography/sectors/akalma_exile.md) sector in retaliation for Empress Paizul's assassination, it left behind an unprecedented salvage field. [House Akalma](../factions/house_akalma.md) had been framed — fabricated evidence placed them at the scene — but Akalma could not escape the manufactured narrative. Bekalu's vengeance was genocide.
...
A self-imposed **Sogmian edict** forbids their kind from ever setting foot in the sector again. [MUD](../factions/mud.md) filled the power vacuum. The scavengers filled the wreckage.

### Professionalization (~2550s–Present)

The emergence of the **Flotsam Exchange** in MRZ-12 orbit gave crews a stable market. [Relic Baron](../factions/relic_barons.md) agents began offering premium prices for artifacts. By the 2600s, millions participated in the salvage economy — a decentralized workforce larger than many factions' entire populations.

---

## The Scavenger's Code

> *"It's not written down. Writing it down would make it a law."*
> — **Drip**
...
The devastated [Akalma Exile](../geography/sectors/akalma_exile.md) sector is the scavenger capital — the largest continuous ruin field in Galia. It is organized informally into depth tiers:
...
At Deep tier, the Cosmic Current cries become **targeted** — scavengers report hearing specific voices addressing them by name. The hauntings are not metaphor: the Cosmic Currents are manifestations of [Iris's](../cosmology/iris_zodiac.md) mind, and the departed Sogmians' grief is literally encoded in the cosmic fabric. Whether the cries are echoes or active communication is one of the Akalma Deep's unanswered questions.
...
|------|------|-------|-------------|
| **The Whisper Engine** | ~2571 | [Malkabaets](../factions/malkabaets.md) | A Sogmian device resonating with the Cosmic Current, producing structured sound some interpret as words. Sold for a fortune |
| **The Sogmian Memory Core** | ~2589 | [Scriptorium](../factions/scriptorium_of_the_lumikir.md) | Personal journals and political correspondence from [House Akalma](../factions/house_akalma.md) — potentially containing evidence the House was innocent of Paizul's assassination |
| **The Void Anchor** | ~2603 | Under study | An impossibly dense object found in a Cosmic Current cavity. Origin unknown — generates localized gravitational anomalies. Possibly a [Living Factories](../factions/living_factories.md) artifact. If confirmed, would represent spatial manipulation rather than information processing |
| **The Cradle Corridor Map** | ~2614 | Relic Barons | An Ustur-format navigational dataset mapping sectors near the HRZ border |

The **Sogmian Memory Core** is politically explosive. If Akalma was truly framed for Paizul's assassination, Bekalu's vengeance was committed against the innocent — and the real assassin remains unidentified. The [Scriptorium](../factions/scriptorium_of_the_lumikir.md) has not published its analysis.
...
- **Marketplace** — where crews sell salvage to buyers, intermediaries, and [Relic Baron](../factions/relic_barons.md) agents
...
| **Hauler** | Transport — moves salvage to the Exchange. Primary target for [Sorkof Pirates](../factions/sorkof_pirates.md) and [Jorvik](../factions/jorvik.md) raiders |
...
| Name | Species | Role |
|------|---------|------|
| **Rig Boss Fennek** | [Mierese](../species/mierese.md) | Most notorious crew leader — Deep-tier specialist of the Bonepickers |
| **Drip** | [Human](../species/human.md) | Ghost (scout) — 14 Deep-tier entries survived. Fennek's chief scout |
| **Clatter.lrnr** | [Ustur](../species/ustur.md) | Cutter — found the Cradle Corridor Map |
| **Sevra Cull** | [Human](../species/human.md) | Retired Ghost — solo Memory Core recovery. Survived a Maw attempt |
| **Rig Boss Kott** | [Punaab](../species/punaab.md) | Retired — discovered the Whisper Engine |
| **"Needle" Jorr** | [Mierese](../species/mierese.md) | Relic Baron agent at the Flotsam Exchange — primary Whisperkin contact |
| **Rig Boss Hasp** | [Human](../species/human.md) | Leader of "The Corroded" — War Wreck specialist |

---

## The Scavenger Paradox

The [Malkabaets](../factions/malkabaets.md) COP movement uses the Exile Scavengers as their strongest argument for HRZ colonization:
...
|---------|--------------|
| [Relic Barons](../factions/relic_barons.md) | Exploitative symbiosis — scavengers supply, Barons resell at massive markup |
| [Iris Academy](../factions/iris_academy.md) | Occasional buyer of anomalous specimens and biological samples |
| [Scriptorium of the Lumikir](../factions/scriptorium_of_the_lumikir.md) | Data recovery buyer — premium prices for historical records |
| [Malkabaets](../factions/malkabaets.md) | Political mixed relationship — COP uses scavengers as HRZ proof, scavengers oppose the policy |
| [House Akalma](../factions/house_akalma.md) | HRZ neighbors — possible contact during Akalma's exile period |
| [Living Factories](../factions/living_factories.md) | Indirect — Void Anchor may be a Living Factories artifact |
| [Izarians](../factions/izarians.md) | Near-contact — discovered underground city with active defenses |
| [Umbral Court](../factions/umbral_court.md) | Risk — crews near Twilight Nebula risk Umbral encounter |
| [Sorkof Pirates](../factions/sorkof_pirates.md) | Hostile — raid salvage haulers |
| [Jorvik](../factions/jorvik.md) | Hostile — tax and raid crews at chokepoints |
...
- [Akalma Exile](../geography/sectors/akalma_exile.md) — Primary ruin field, haunted Sogmian sector
- [Izar-248](../geography/sectors/izar.md) — Underground city discovery

### Factions

- [Relic Barons](../factions/relic_barons.md) — Artifact market
- [Malkabaets](../factions/malkabaets.md) — HRZ proof point / scavenger paradox
- [House Akalma](../factions/house_akalma.md) — Source of primary salvage site
- [Living Factories](../factions/living_factories.md) — Void Anchor connection
- [Izarians](../factions/izarians.md) — Underground first contact potential
- [Umbral Court](../factions/umbral_court.md) — Twilight Nebula encounter risk

### Species

- [Sogmian](../species/sogmian.md) — Bekalu's vengeance, Akalma framing, Cosmic Current hauntings

### Meta

- [Named Characters](../meta/named_characters.md) — Fennek, Drip, Clatter.lrnr, Sevra Cull, Kott, Needle Jorr, Hasp
