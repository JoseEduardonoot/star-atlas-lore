...
| **Parent** | [Xianyang Government](../factions/xyanyang_government.md) |
| **Primary Client** | [Free Cities of Humanity](../factions/redam_government.md) |
...
When the five MUD ex-colonies — [Redam](../factions/redam_government.md), [Mycenas](../factions/mycenas_government.md), [Xianyang](../factions/xyanyang_government.md), [Pergamos](../factions/pergamos_new_government.md), and [Abyd](../factions/abyd_government.md) — broke from MUD civilization in the post-Convergence War chaos (~2522), each responded differently. Redam built bridges. Mycenas built walls. Abyd collapsed into warlordism. Xianyang built an army.
...
The transformative moment came when Xianyang-VI, **nearly overwhelmed by alien invaders** (~2547), forged a desperate alliance with the [Gate Garrison](../factions/gate_garrison.md) — the legendary bounty-hunter collective from the High-Risk Zone, led by the enigmatic [Stommtharic](../factions/gate_garrison.md).
...
> *"In Redam, they vote. In Mycenas, they trade. In Xianyang, they fight. That's not a political statement — it's a census category."*
> — Galactic Indices analyst
...
> *"The Executor doesn't give speeches. He gives coordinates."*
> — Enforcer officer, debriefing

### Character

Executor Rhenn Kyung is the Enforcers' commanding officer — a 30-year [Gate Garrison](../factions/gate_garrison.md) veteran who transferred to lead Xianyang's military arm when the Enforcers were formally chartered. His career trajectory represents the alliance itself: trained in the HRZ by the most dangerous bounty-hunters in the galaxy, then deployed to build the most powerful conventional military force among the ex-MUD colonies.

Kyung is a tactician, not a politician. He does not engage in the diplomatic theater that characterizes the [Free Cities](../factions/redam_government.md) — when the Exalted Lords of Redam's Assembly send him somewhere, he goes. When diplomacy fails, he fights. When he fights, he wins. The Enforcers' reputation for overwhelming intervention often resolves conflicts before they arrive because potential adversaries know what Kyung brings to the field.
...
|------|---------|------|---------|
| **Executor Rhenn Kyung** | [Human](../species/human.md) | Commander — Xianyang Enforcers | 30-year Gate Garrison veteran. Tactician, not politician. Coordinates, not speeches. The iron fist behind Redam's velvet glove |
| **Vice-Executor Mara Tenshing** | [Human](../species/human.md) | Deputy Commander — Operations | Former Rite of Passage instructor who wrote the current Enforcer training doctrine. Known for memorizing every unit's deployment schedule across all 12+ battlefronts |
| **Sergeant-Major Doss Kelwrath** | [Human](../species/human.md) | Senior NCO — Abyd Theater | Longest-serving field soldier in the Abyd pacification. Twenty years of continuous deployment. Carries a standing offer from Gate Garrison that he has refused three times |
| **Lieutenant Yara Sondheim** | [Human](../species/human.md) | Alumni Network Coordinator | Officially a "veteran affairs liaison." Unofficially the Enforcers' intelligence asset who tracks every active alumnus across Galia Expanse |
...
|---------|--------------|
| [Xianyang Government](../factions/xyanyang_government.md) | Parent — military dictatorship that created and directs the Enforcers |
| [Free Cities of Humanity](../factions/redam_government.md) | Primary client — deployed "when diplomacy fails" |
| [Gate Garrison](../factions/gate_garrison.md) | Alumni pipeline — Enforcers are modeled on Garrison methodology. Shared HQ on Xianyang-VI |
| [Abyd](../factions/abyd_government.md) | Primary theater of operations — pacification and infrastructure protection |
| [Redam Government](../factions/redam_government.md) | Diplomatic coordinator — deploys Enforcers as enforcement mechanism |
| [Council of Peace](../institutions/council_of_peace.md) | Adversarial — Xianyang has threatened to defy COP resolutions |
| [Nimrod Trackers](../factions/nimrod_trackers.md) | Professional respect — different mandates, occasional operational overlap |

---

## Cross-References

- Xianyang Government (parent) — [xyanyang_government.md](./xyanyang_government.md)
- Gate Garrison (alumni pipeline) — [gate_garrison.md](./gate_garrison.md)
- Redam Government (primary client) — [redam_government.md](./redam_government.md)
- Abyd Government (primary theater) — [abyd_government.md](./abyd_government.md)
- Xianyang-VI sector — [xianyang.md](../geography/sectors/xianyang.md)
- Never Alone Campaign — [never_alone_campaign.md](../narratives/never_alone_campaign.md)
- History — [master_timeline.md](../meta/master_timeline.md) (est. ~2569)
- Planets — [planets.md](../reference/atlas/planets.md) (Korrath coordination point)
