...
> *"Three factions tell you three truths. None of them are THE truth. We broadcast the fourth."*
> — The Real Truth Network tagline
...
> *"The Tenth is always counting. Sleep when you're purged."*
> — RTN channel operator proverb
...
During the [Sogmian](../species/sogmian.md) civil war (~2420), a House Outro journalist **infiltrated Vega's stronghold** and produced evidence that changed the course of the conflict. That single act proved a principle that nobody had articulated before: **information, freely distributed, is more powerful than any fleet.**
...
The [Scriptorium of the Lumikir](../factions/scriptorium_of_the_lumikir.md) represents the RTN's philosophical counterpart: the Scriptorium **records** truth with deliberate care; the RTN **broadcasts** it with competitive urgency. Both serve information. They serve it differently. The Scriptorium keeps truth safe. The RTN makes truth dangerous.
...
| **Conspiracy Channels** | Theories about [Iris](../cosmology/iris_zodiac.md), the [Cataclysm](../geography/the_cataclysm.md), faction cover-ups | Enormous audiences — the Tenth Cycle rewards this |
...
The [Council of Peace](../institutions/council_of_peace.md) maintains an active monitoring operation, formally considering the RTN **"a potential threat to galactic stability."** Officials regularly leak information to RTN channels when it serves political interests — making the Network the galaxy's most effective tool for anonymous whistleblowing.
...
The [Iris Academy](../factions/iris_academy.md) — the galaxy's premier research institution — maintains a quiet relationship with the RTN through investigative journalist **Jorik Ashe**, who serves as a bridge between the Academy's research establishment and the RTN's broadcast platform. Ashe works with **Prof. Yulun Brass** as his primary Academy contact, gaining access to research that the Academy wants disseminated but cannot officially publish.
...
|---------|------|----------|---------------|-------------|
| **The Fourth Signal** | **Renna Okoro** ([Human](../species/human.md), female) | Anchor — Investigative | Top 5 | RTN's most respected channel. Broke the [Frenir](../geography/sectors/frenir.md) slave trade story years before the COP intervention. The benchmark for RTN journalism |
...
| **The Laughing Void** | **Duulo** ([Punaab](../species/punaab.md), male) | Satire — Comedy | Top 10 | Impersonations of faction leaders are legendary. Multiple assassination attempts — all failed, all became content |
| **Frontline Feed** | **Kess** ([Mierese](../species/mierese.md), non-binary) | War — Live Combat | Top 15 | Broadcasts from active conflict zones. Reportedly killed three times by different factions — keeps broadcasting. Either extremely lucky or multiple operators using the name |
| **Sector Pulse** | **Greth Voraan** ([Sogmian](../species/sogmian.md), male) | Specialist — MRZ Politics | Top 20 | Former ONI diplomatic aide who left after being ordered to suppress information. Connections make his analysis dangerously accurate |

### Channel Profiles

**Renna Okoro — The Fourth Signal**: The name is deliberate — four signals, four truths, the one the factions won't tell you. Renna broke the [Slavers of Frenir](../factions/slavers_of_frenir.md) story years before Commander [Vaor Scarka](../factions/oni.md) led the COP intervention. When the intervention finally happened, Renna's footage was so comprehensive that COP investigators used her broadcasts as evidence. She is the RTN's proof that the platform can serve justice.

**The Veil Lifted — Anonymous**: The most-watched conspiracy channel on the network. Its anonymous operator has theorized that [Iris](../cosmology/iris_zodiac.md) is sentient, that the [Convergence War](../history/convergence_war.md) was manufactured by the [Living Factories](../factions/living_factories.md), and that the [Cataclysm](../geography/the_cataclysm.md) was not a natural event but a weapon test. Some of these theories are demonstrably wrong. Some are uncomfortably close to canon truths no faction has confirmed. The identity of the operator remains unknown — which is, of course, content in itself.
...
| **Pergamos shadow economy** | RTN channels circulated evidence of [Shadow Bank](../factions/pergamos_shadow_banks.md) operations — suspected of receiving funding from the same banks they expose |
...
The [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) are suspected of funding RTN channels through shell companies — creating the perverse situation where the same financial institutions being investigated by RTN journalists are paying for the investigation. Whether this is irony or strategy depends on which Prince you ask.
...
|---------|--------------|
| [Council of Peace](../institutions/council_of_peace.md) | Frequent target of criticism; secretly a source of leaks |
| [Collective Anarchy](../factions/the_collective_anarchy.md) | Infrastructure ally — some RTN channels amplify Collective broadcasts |
| [Scriptorium of the Lumikir](../factions/scriptorium_of_the_lumikir.md) | Philosophical counterpart — record vs. broadcast |
| [Iris Academy](../factions/iris_academy.md) | Research pipeline — Jorik Ashe provides scientifically credible broadcasts |
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Suspected of funding channels through shell companies |
| [Ophek](../factions/ophek.md) | Entertainment sector rival — competing for galactic audiences |
| [MUD](../factions/mud.md) / [ONI](../factions/oni.md) / [Ustur](../species/ustur.md) | The three major media empires the RTN exists to counter |
...
- [Collective Anarchy](../factions/the_collective_anarchy.md) — Broadcast infrastructure alliance
- [Scriptorium of the Lumikir](../factions/scriptorium_of_the_lumikir.md) — Record vs. broadcast philosophy
- [Iris Academy](../factions/iris_academy.md) — Jorik Ashe research pipeline
- [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) — Suspected funding
- [Ophek](../factions/ophek.md) — Entertainment rivalry
- [Slavers of Frenir](../factions/slavers_of_frenir.md) — Fourth Signal broke the story

### Institutions

- [Council of Peace](../institutions/council_of_peace.md) — "Potential threat to galactic stability"

### Cosmology

- [Iris](../cosmology/iris_zodiac.md) — Conspiracy channel content (The Veil Lifted)

### Meta

- [Named Characters](../meta/named_characters.md) — 5 channel operators + Jorik Ashe
