...
> *"Strength lies not in conquest, but in the delicate balance of words and wealth. To rule the galaxy, one need not fire a shot — only open the right doors."*
> — **Lord-Speaker Gareth Dravus**, address to the Exalted Lords, ~2560

| | |
|---|---|
| **Type** | Neutral diplomatic state / ex-MUD coalition hub |
| **Species** | [Human](../species/human.md) (predominantly) |
...
| **Coalition** | [Mycenas](../factions/mycenas_government.md) · [Xianyang](../factions/xyanyang_government.md) · [Abyd](../factions/abyd_government.md) · [Pergamos (New)](../factions/pergamos_new_government.md) |
...
Forged in the ashes of the MUD Empire's collapse, Redam-VII has evolved from a colonial outpost into the **diplomatic nerve center** of the former MUD territories. Where [Mycenas](../factions/mycenas_government.md) responds to the post-independence chaos with paranoid isolation and [Abyd](../factions/abyd_government.md) collapses into warlordism, Redam builds. Bridges. Trade routes. Coalitions. And when bridges fail, it deploys the [Xianyang Enforcers](../factions/xianyang_enforcers.md) — the iron fist inside the velvet glove.
...
But sovereignty is a currency that must be constantly earned. The MRZ is not the Safe Zone. Outside Redam's sphere of influence, the [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) finance wars for profit, [Jorvik](../factions/jorvik.md) pirates raid with impunity, and [ECOS](../factions/earth_conscious_ontological_society.md) agricultural leverage can cripple an entire sector in weeks. Redam's answer to all of these threats is the same: talk first, deploy Enforcers second, and never let anyone forget that the food supply runs through channels Redam does not control.
...
Redam-VII was established during the MUD Empire's aggressive push into the Medium Risk Zone around **~2426**, one of five colonies planted as stepping stones toward the galactic core: [Mycenas-V](../factions/mycenas_government.md), [Xianyang-VI](../factions/xyanyang_government.md), **Redam-VII**, [Pergamos-VIII](../factions/pergamos_new_government.md), and [Abyd-IX](../factions/abyd_government.md). Designated MRZ-1, Redam was strategically positioned as a **commerce nexus** — a bridge point between MUD's Safe Zone and the deeper MRZ systems.
...
The [Convergence War](../history/eras_of_star_atlas.md) shattered the galactic order. When [The Accord](../history/eras_of_star_atlas.md) ended hostilities (~2523), all five MUD ex-colonies in the Medium Risk Zone — **Redam, Mycenas, Xianyang, Pergamos, and Abyd** — broke away from MUD civilization.
...
The effort **failed catastrophically**. The deep fragmentation and mistrust between medium zone powers — compounded by centuries of colonial exploitation, post-independence border disputes, and the active sabotage of factions like the [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) (who profited from disunity) — made any collective agreement impossible. Former colonies that had fought each other for resources refused to sit at the same table. Species-based factions viewed the attempt as a MUD power grab. Even Redam's own coalition partners were lukewarm.
...
In ~2612, the [Council of Peace](../institutions/council_of_peace.md) authorized a large-scale mining operation in Redam sector — backed by MUD industrial interests. The operation began strip-mining a world that [ECOS](../factions/earth_conscious_ontological_society.md) druidesses had identified as possessing early-stage sentient biosphere indicators. ECOS diplomats protested. The COP Senate dismissed the protest.

[Arch Druidess Kaelen Rhos](../factions/hanging_gardens_government.md) — the ECOS Speaker of the Verdant Root Grove, known as "The Patient Harvest" — did not deploy military assets. She did not declare a Mourning Cycle. She did not raise her voice.

She redirected grain shipments.

For six weeks, every ECOS agricultural supply line to Redam sector was rerouted to neighboring systems. No announcement. No threats. The grain simply stopped arriving. Within **three weeks**, food prices in Redam had **tripled**. Within five, civilian protests forced the sector government to appeal to the COP for emergency supplies. The COP dispatched relief — but [CARY's](../institutions/council_of_peace.md) capacity could not replace **thirteen percent of the MRZ's agricultural output** overnight.
...
When the [COP](../institutions/council_of_peace.md) — under the influence of Commander **Vaor Scarka** — began invading MRZ territories (the [Pergamos intervention](../geography/sectors/pergamos.md), the [Frenir](../geography/sectors/frenir.md) occupation), the MRZ faced an existential threat. The peace-keeping body had become an aggressor.

Redam, fearing it would be next, did what it does best: it built a coalition.

Lord-Speaker Dravus reached out to the **old MUD colonies**, to [Zenith Door](../geography/sectors/zenith_door.md) — where the Elder [Chior.eldr](../geography/sectors/zenith_door.md) had been the galaxy's most prominent voice against COP militarism — and to the [Free Harbors](../geography/sectors/free_harbors.md), the MRZ's commercial heart. The message was simple: *if we don't stop this now, the COP will pacify every independent sector in the medium zone.*
...
> *"They call themselves 'free.' Free to argue. Free to backstab. Free to accomplish nothing unless something is literally on fire."*
> — Anonymous COP observer
...
|--------|----------------|---------------|
| **[Redam](../factions/redam_government.md)** | Diplomacy, trade corridors, COP relationships | Needs the others' resources and military strength |
| **[Mycenas](../factions/mycenas_government.md)** | Force field technology — shields willing members' worlds | Needs Redam to talk to the galaxy so Mycenas doesn't have to |
| **[Xianyang](../factions/xyanyang_government.md)** | Raw military power (~3,000,000 active Enforcers) | Needs economic partners to sustain its war machine |
| **[Abyd](../factions/abyd_government.md)** | Mineral extraction — rare construction alloys | "Member" is generous — whoever controls Abyd Station-1 sends a delegate |
| **[Pergamos](../factions/pergamos_new_government.md)** | Financial infrastructure, trade routing | Needs external legitimacy after COP intervention |
...
- **Major pirate incursions**: When [Jorvik](../factions/jorvik.md) raids threaten multiple sectors simultaneously, Xianyang's Enforcers deploy while Redam coordinates logistics and Mycenas extends shield coverage.
...
Redam's greatest economic vulnerability is its **food supply**. ECOS — specifically the [Hanging Gardens](../factions/hanging_gardens_government.md) agricultural network — provides a significant fraction of the MRZ's grain supply. The ~2612 Grain Crisis proved that this dependency can be weaponized.
...
| **Commander** | **Executor Rhenn Kyung** — 30-year veteran, [Gate Garrison](../factions/gate_garrison.md) alumni |
| **Recruitment** | Heavy recruitment from Gate Garrison alumni — HRZ combat veterans who outclass conventional MRZ forces |
| **Primary Theater** | [Abyd](../factions/abyd_government.md) — most frequent deployment, least lasting success |
...
The [Mycenas Government](../factions/mycenas_government.md) contributes something no other faction can provide: **force field technology** that shields the coalition's core worlds. This passive defense transforms Redam's core territory from a standard MRZ sector into something approaching Safe Zone security levels.
...
|---------|-------------|-------|
| [MUD Faction](../species/human.md) | Pro-MUD (but independent) | Mutually beneficial — trade, intelligence, cultural ties; ⚠️ Teyn is a MUD intelligence asset |
| [Mycenas Government](../factions/mycenas_government.md) | Coalition member | Shield provider — irreplaceable defensive technology |
| [Xianyang Government](../factions/xyanyang_government.md) | Coalition member | Provides Enforcers — military enforcement arm |
| [Xianyang Enforcers](../factions/xianyang_enforcers.md) | Coalition military arm | ~5,000 personnel deployed coalition-wide; Gate Garrison alumni |
| [Abyd Government](../factions/abyd_government.md) | Pacification partner | Primary Enforcer theater; Brekker is Redam's preferred warlord |
| [Pergamos New Government](../factions/pergamos_new_government.md) | Regional partner | COP-installed post-intervention authority; member of the Free Cities of Humanity |
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Adversary (indirect) | Exiled but still operating; profits from MRZ instability that Redam tries to prevent |
| [COP](../institutions/council_of_peace.md) | Tentative ally | Accepted COP truce after ~2623 coalition pressure; wary of Scarka's militarism |
| [ECOS / Hanging Gardens](../factions/hanging_gardens_government.md) | Dependency / cautious respect | Grain supply vulnerability exposed by ~2612 blockade; relationship is functional but fragile |
| [Jorvik](../factions/jorvik.md) | Adversary | Pirate operations destabilize Abyd and threaten MRZ trade routes |
| [MUD Synod](../species/human.md) | Observed with concern | Synod's financial recolonization strategy in ex-colonies like Abyd threatens Redam's independent coalition model |
| [Zenith Door / Chior.eldr](../geography/sectors/zenith_door.md) | Coalition ally (~2623) | Key partner in COP truce pressure; Chior is the galaxy's most prominent pacifist voice |
| [Free Harbors](../geography/sectors/free_harbors.md) | Coalition ally (~2623) | Commercial heart of MRZ; joined Redam's COP truce outreach |
...
|------|---------|------|--------|
| **Gareth Dravus** | [Human](../species/human.md) | Lord-Speaker — Exalted Lord of Redam-VII, coalition architect | Active |
| **Tsera Vyll** | [Human](../species/human.md) | Exalted Lord of Eryndor — logistics and trade | Active |
| **Rogan Veth** | [Human](../species/human.md) | Exalted Lord of Korrath — military advocate, frontier defense | Active |
| **Maren Teyn** | [Human](../species/human.md) | Exalted Lord of Valthara — economist; ⚠️ MUD intelligence asset | Active |
| **Gorath Zyn** | [Human](../species/human.md) | Exalted Lord of Drakal — warrior-culture, elite guard training | Active |
| **Executor Rhenn Kyung** | [Human](../species/human.md) | Commander, Xianyang Enforcers — 30-year veteran, Gate Garrison alumni | Active |
...
- Timeline — [master_timeline.md](../meta/master_timeline.md) (~2524 stabilization, ~2555 failed league, ~2623 truce)
- Redam sector — [redam.md](../geography/sectors/redam.md)
- Mycenas Government — [mycenas_government.md](./mycenas_government.md) (coalition shield provider)
- Xianyang Enforcers — [xianyang_enforcers.md](./xianyang_enforcers.md) (coalition military arm)
- Abyd Government — [abyd_government.md](./abyd_government.md) (pacification partner, mineral routes)
- Pergamos New Government — [pergamos_new_government.md](./pergamos_new_government.md) (regional partner)
- Pergamos Shadow Banks — [pergamos_shadow_banks.md](./pergamos_shadow_banks.md) (adversary, war profiteering)
- Hanging Gardens Government — [hanging_gardens_government.md](./hanging_gardens_government.md) (~2612 Grain Crisis)
- Zenith Door — [zenith_door.md](../geography/sectors/zenith_door.md) (~2623 coalition partner, Chior.eldr)
- Free Harbors — [free_harbors.md](../geography/sectors/free_harbors.md) (~2623 coalition partner)
- Council of Peace — [council_of_peace.md](../institutions/council_of_peace.md) (~2623 truce, Scarka threat)
- Eras of Star Atlas — [eras_of_star_atlas.md](../history/eras_of_star_atlas.md) (Convergence War, Accord)
- Named Characters — [named_characters.md](../meta/named_characters.md) (Exalted Lords, Executor Rhenn Kyung)
