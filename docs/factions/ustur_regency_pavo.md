...
> *"A corridor that chooses Ustur alignment because it becomes economically rational — not because of occupation."*
> — Ustur strategic doctrine for MRZ sectors
...
> *"The Ustur do not conquer. They audit. And an audit from the Regency is more terrifying than a battalion."*
> — Cathris Port Authority operative
...
The Regency operates through oversight, permits, and audit pressure — stabilizing the corridor, reducing corruption, and preventing visible collapse without becoming an occupier. Their tools: audits, permits, reclassification, targeted sanctions, and quiet alliances with stability-oriented actors like [VHE](../factions/vale_horizon_exchange.md).
...
Korin.tchr's classification standards are the regulatory framework that [TAPP](../factions/toll_authority_of_pavo_passage.md) operates within. Every toll schedule, every permit requirement, every cargo inspection protocol traces back to standards that a Ustur Teacher-stage bureaucrat defines. This is structural power — the most fundamental kind.

---

## The VHE Alliance

The Regency's most important deniable alliance is with the [Vale Horizon Exchange](../factions/vale_horizon_exchange.md). VHE's existence prevents [MTC](../factions/meridian_trading_company.md) monopoly — which prevents MUD/Synod soft capture of the sector — which prevents the escalation that would force Ustur military intervention.
...
| **Elias Dorn** (Neutral/Agriculture) | [Order of Seasons](../factions/order_of_seasons.md) (deep cover) | Unpredictable — votes to maintain imbalance |
| **Varn Crathis** (High Consul) | [Crumon Dynasty](../factions/crumon_dynasty.md) | Issue-dependent — opposes MTC when Dynasty interests threatened |
...
The Regency's most frustrating challenge is the [Order of Seasons](../factions/order_of_seasons.md). The Order's covert harvest operations target precisely the kind of actors the Regency would also like to remove — corrupt operators, exploitative factions, destabilizing elements. But the Order does not coordinate with the Regency. It does not negotiate. It does not announce. It operates as a **ghost variable** — a factor the Regency cannot chart, cannot summon, and cannot control.
...
| Faction | Posture |
|---------|---------|
| [Ruling Conclave](../factions/ruling_conclave.md) | Control interface — the Regency accepts the Conclave as governance framework while quietly shaping its decisions |
| [MTC / Synod](../factions/meridian_trading_company.md) | Tolerates commerce, blocks sovereignty — polite compliance on the surface, structural obstruction underneath |
| [Vale Horizon Exchange](../factions/vale_horizon_exchange.md) | Quiet deniable support — VHE as commercial proxy for Ustur stability interests |
| [Toll Authority (TAPP)](../factions/toll_authority_of_pavo_passage.md) | Regulatory parent — Korin.tchr's classification standards define TAPP's operating framework |
| [Crumon Dynasty](../factions/crumon_dynasty.md) | Pragmatic engagement — the Dynasty's weakened state serves Ustur interest in balanced power distribution |
| [Order of Seasons](../factions/order_of_seasons.md) | Ghost variable — cannot chart, cannot summon, cannot control |
| [Winter Fist Path](../factions/winter_fist_path.md) | Aligned values — both serve stability through presence, not force. Saelyra.soul's Path philosophy compatible with Regency doctrine |
| [COP](../institutions/council_of_peace.md) | Formal mandate — the Regency operates under COP authority to stabilize MRZ corridors |
...
- [Ruling Conclave](../factions/ruling_conclave.md) — 2 Conclave seats (Ord.eldr + Korin.tchr)
- [Vale Horizon Exchange](../factions/vale_horizon_exchange.md) — Deniable commercial alliance
- [Meridian Trading Company](../factions/meridian_trading_company.md) — Commercial tolerance, sovereignty barrier
- [Toll Authority (TAPP)](../factions/toll_authority_of_pavo_passage.md) — Classification standards, regulatory framework
- [Order of Seasons](../factions/order_of_seasons.md) — Ghost variable
