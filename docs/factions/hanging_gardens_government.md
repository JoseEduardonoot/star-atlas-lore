# Hanging Gardens Government

> *"You ask me how I sleep at night, Senator, knowing I could starve your worlds. I sleep the way the soil sleeps — patiently, and with absolute certainty that spring will come whether you approve of it or not."*
> — **Arch Druidess Kaelen Mossgrieve**, "The Patient Harvest," addressing a COP Senate delegation

| | |
|---|---|
| **Type** | [ECOS](../factions/earth_conscious_ontological_society.md) sector government / agricultural superpower |
| **Species** | Multi-species ([Human](../species/human.md)-majority) |
| **Governance** | Council of Arch Druidesses — the [High Circle](../factions/earth_conscious_ontological_society.md) |
...
| **Key Asset** | [Superphoenix](../factions/fimbul_ecos.md) titan-class bioship |
...
In the early decades of their exile from [MUD](../species/human.md), ECOS settled a pristine world they named **Old Grove** — a lush, biodiverse planet that seemed to embody everything they believed in. For the first time, they had the resources and the freedom to test their most ambitious idea: active terraforming, reconsidering the relationship between civilization and ecosystem by designing both simultaneously.
...
ECOS fled to MRZ-16 specifically because it lay within Ustur-aligned space. The [Ustur](../species/ustur.md) — robotic elders whose civilization predates most organic species — maintained a sphere of influence across MRZ-16 that served as an implicit shield. MUD had never forgiven the schism of ~2401, when ECOS dissidents discovered that [Ahr](../species/human.md) — humanity's alien benefactor — was a [Photoli](../species/photoli.md) manipulating human civilization for unknown purposes. If MUD could reach the Hanging Gardens, they would have exterminated ECOS long ago. Ustur protection — whether intentional or passive — kept ECOS alive.
...
> *"Old Grove taught us that we could not command a world. The Gardens taught us that we never needed to. You do not command a god. You ask."*
> — Arch Druidess Andrezza
...
In ~2615, ECOS revealed the **Superphoenix** — a titan-class biomechanical warship built by the [Fimbul ECOS](../factions/fimbul_ecos.md) division over approximately 25 years. The largest ship in ECOS's arsenal, the Superphoenix was stationed at the Hanging Gardens as a **permanent deterrent**.

The Superphoenix is not merely a warship. It is a [Fimbul](../factions/fimbul_industries.md) masterpiece — a nation-carrier housing a small, flourishing civilization aboard, with terrestrial comforts designed to keep citizens grounded and healthy during eternal cruising. Its photosynthetic hull self-heals battle damage. Its interior is a cathedral of vines and bioluminescent growth. Every detail reflects ECOS's nature-first philosophy, and below the serene atriums lies serious military capability — including a siege solar cannon and terraforming warheads.
...
The Hanging Gardens is formally designated the **Verdant Root** — the first and most senior grove in the ECOS network. Where other groves specialize (pharmacology for [Thornveil](../factions/thornveil_grove.md), biodefense for [Duskbloom](../factions/duskbloom_grove.md), terraforming for [Lumiro](../factions/lumiro_grove.md)), the Verdant Root's specialization is *everything*: food production, public diplomacy, agricultural policy, druidess training, and the coordination of the entire grove network.
...
| 2 | **The Warden** | [Balifa Grove](../factions/balifa_grove.md) | **[Andreza Liora](../factions/balifa_grove.md)** | Ecological warfare, radical doctrine, Mourning Cycles |
| 3 | **The Mender** | [Lumiro Grove](../factions/lumiro_grove.md) | **[Orra Windraft](../factions/lumiro_grove.md)** | Terraforming, emergency environmental response |
| 4 | **The Alchemist** | [Thornveil Grove](../factions/thornveil_grove.md) | **[Selara Nai](../factions/thornveil_grove.md)** | Pharmacology, coral research, bio-medicines |
| 5 | **The Penitent** | [Ashroot Grove](../factions/ashroot_grove.md) | **[Venya Sorrow](../factions/ashroot_grove.md)** | [Old Grove](../geography/sectors/old_grove.md) containment, penance, historical memory |
| 6 | **The Sentinel** | [Duskbloom Grove](../factions/duskbloom_grove.md) | **[Yeva Thornwind](../factions/duskbloom_grove.md)** | Biodefense, [Dark Photoli](../factions/dark_photoli.md) threat response |
| 7 | **The Scholar** | [Deepwell Grove](../factions/deepwell_grove.md) | **[Miara 𐎉 Garveil](../factions/deepwell_grove.md)** | Xenobiology, Termik protection, species cataloguing |
...
> — **Miara 𐎉 Garveil** (Deepwell/Scholar), private correspondence
...
| [Balifa Grove](../factions/balifa_grove.md) | Mobile (Superphoenix) | Ecological warfare, radical doctrine |
| [Lumiro Grove](../factions/lumiro_grove.md) | Eol-Garadar (MRZ-23) | Terraforming, emergency response |
| [Thornveil Grove](../factions/thornveil_grove.md) | Communion sector | Pharmacology, coral research |
| [Ashroot Grove](../factions/ashroot_grove.md) | Old Grove perimeter | Containment, penance |
| [Duskbloom Grove](../factions/duskbloom_grove.md) | [Everstorm](../geography/sectors/everstorm.md) border | Biodefense, threat monitoring |
| [Deepwell Grove](../factions/deepwell_grove.md) | [Ilidae](../geography/sectors/ilidae.md) | Xenobiology, Termik protection |
...
- **Revenue generation** — agricultural income flows through the [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md), bypassing COP financial oversight
- **Soft power accumulation** — worlds that eat ECOS food gradually become sympathetic to ECOS philosophy

### The CARY Rivalry

The Hanging Gardens' primary commercial rival is **CARY** — the civilian agricultural division of [Calico Industries](../manufacturers/calico.md), a MUD/ONI collaborative manufacturer. Where ECOS practices communion-guided agriculture rooted in planetary theology, CARY pursues sustainable farming through scientific innovation, stealth technologies, and interspecies collaboration.
...
> *"Old Grove taught us that we could not command a world. The Gardens taught us that we never needed to. You do not command a god. You ask."*
> — **Kaelen Mossgrieve**, Rite of First Communion address
...
> *"She doesn't conquer worlds. She feeds them until they forget they were ever hungry for anything else."*
> — COP intelligence assessment, classified

### The Redam Blockade (~2612)

The event that cemented Kaelen's reputation — and earned her the epithet "The Patient Harvest" — was the [Redam](../factions/redam_government.md) crisis.

In ~2612, the COP authorized a large-scale mining operation in [Redam](../geography/sectors/redam.md) sector — a neutral diplomatic state that had relied on ECOS grain imports for decades. The mining operation, backed by MUD industrial interests, began strip-mining a world that ECOS druidesses had identified as possessing early-stage sentient biosphere indicators. ECOS diplomats protested. The COP Senate dismissed the protest.
...
Kaelen personally negotiated the financial channel between ECOS agricultural revenue and the [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md). The details of these negotiations remain unknown — but the result speaks volumes: ECOS's entire agricultural income now flows outside COP financial oversight, funding grove operations, military procurement, and covert diplomacy without a single transaction appearing on a COP-regulated ledger.
...
> *"I have heard Andreza's rage and Orra's compassion and Miara's wisdom. But when Kaelen speaks — truly speaks, in the Rite — it is not Kaelen's voice I hear. It is something that was speaking long before any of us were born, and will be speaking long after the last ship falls silent."*
> — **Venya Sorrow** (Ashroot/Penitent)
...
| Name | Species | Role |
|------|---------|------|
| **Kaelen Mossgrieve** | [Human](../species/human.md) | "The Patient Harvest" — High Circle Seat 1. Speaker of the Verdant Root, architect of soft communion, and the most dangerous diplomat in the MRZ |
| **Harkon Y** | [Human](../species/human.md) | [Fimbul ECOS](../factions/fimbul_ecos.md) chief engineer. Eldest son of Ben Y. Married Arch Druidess Thyra Greenveil and relocated operations to the Gardens |
| **Thyra Greenveil** | [Human](../species/human.md) | Arch Druidess, wife of Harkon Y. Bridges Fimbul engineering and ECOS theology |
| **[Andreza Liora](../factions/balifa_grove.md)** | [Human](../species/human.md) | "The Warden" — High Circle Seat 2. Speaks for [Balifa Grove](../factions/balifa_grove.md). The radical voice in the council |
| **[Orra Windraft](../factions/lumiro_grove.md)** | [Human](../species/human.md) | "The Mender" — High Circle Seat 3. Speaks for [Lumiro Grove](../factions/lumiro_grove.md). The moderate counterweight |
...
|---------|--------------|
| [ECOS](../factions/earth_conscious_ontological_society.md) | Parent faction — the Verdant Root is the mother-institution of all groves |
| [Fimbul ECOS](../factions/fimbul_ecos.md) | Operational partner — Harkon Y operates from the Gardens; built and maintains the Superphoenix |
| [Ustur](../species/ustur.md) | Implicit protectorate — located in their space; Ustur presence deters MUD aggression |
| [Lumiro Grove](../factions/lumiro_grove.md) | Training pipeline — Lumiro's druidesses are trained at the Gardens |
| [Balifa Grove](../factions/balifa_grove.md) | Radical sibling — Andreza Liora (The Warden) represents the militant wing on the High Circle |
| [Thornveil Grove](../factions/thornveil_grove.md) | Pharmaceutical arm — coral research and bio-medicines |
| [Ashroot Grove](../factions/ashroot_grove.md) | Penitent arm — Old Grove containment and historical memory |
| [Duskbloom Grove](../factions/duskbloom_grove.md) | Biodefense arm — Dark Photoli threat monitoring |
| [Deepwell Grove](../factions/deepwell_grove.md) | Research arm — xenobiology and Termik protection |
| [COP](../institutions/council_of_peace.md) | Military threat — Scarka's MRZ expansion creates flashpoint risk |
| [MUD](../species/human.md) | Existential enemy — MUD would destroy the Gardens if geography permitted |
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Financial partner — agricultural revenue bypasses COP oversight through the Banks |
