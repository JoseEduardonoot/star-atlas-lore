...
> *"Behind the barrier, Mycenas remembers 80 years of screaming. They will never lower it willingly."*
> — Redam diplomatic assessment

| | |
|---|---|
| **Type** | Meritocratic fortress state / [Redam](../factions/redam_government.md) coalition member |
...
| **HQ** | Mycenas-V (MRZ-2) |
| **Key Asset** | HRZ artifact-powered energy barrier — shields entire system, shared with the [Free Cities of Humanity](../factions/redam_government.md) |
...
> — attributed account from the Balifa Campaign
...
**Mycenas-V** was established during the MUD Empire's expansion into the Medium Risk Zone around **~2426** — the fifth of nine colonies, alongside [Xianyang-VI](../factions/xyanyang_government.md), [Redam-VII](../factions/redam_government.md), [Pergamos-VIII](../factions/pergamos_new_government.md), and [Abyd-IX](../factions/abyd_government.md).
...
The [Convergence War](../history/eras_of_star_atlas.md) shattered the galactic order. When hostilities overwhelmed MUD's capacity to maintain its outer colonies, the Empire made a **deliberate strategic decision**: it would sacrifice the MRZ colonies to preserve resources for the core systems.
...
| **Species** | [Human](../species/human.md) (formerly MUD) |
...
- It originates from the **High Risk Zone** — the most dangerous region of the galaxy, home to [Tufa](../species/tufa.md) and metagenic phenomena
...
This system is similar in principle to the [Anfoil State](../factions/anfoil_state.md)'s Meritocratic Technate — both are governed by competence rather than inheritance. The difference is philosophical: Anfoil suppresses emotion through technology; Mycenas channels emotion — specifically fear and rage — into productivity.
...
|-----------------|-------------|---------------------------|
| **[Redam Government](../factions/redam_government.md)** | Diplomatic cover, trade access, COP representation | Force field protection for core worlds |
| **[Xianyang Government](../factions/xyanyang_government.md)** | Military enforcement ([Xianyang Enforcers](../factions/xianyang_enforcers.md)) | Force field protection extends to enforcement range |
| **[Abyd Government](../factions/abyd_government.md)** | Resource extraction (rare minerals) | Limited — Abyd's instability limits shield coverage |
| **[Pergamos New Government](../factions/pergamos_new_government.md)** | Financial reconstruction, trade routing | Limited — Pergamos still recovering |
...
> *"Mycenas can withdraw behind its shields at any time — and its isolationist instincts are strong."*
> — Free Cities internal risk assessment
...
When the COP launched its offensive against [Pergamos](../factions/pergamos_new_government.md) (~2623), Mycenas **threatened to intervene** — not out of love for Pergamos, but because the COP's action reminded Mycenasians of what happens when a galactic power decides a colony is expendable.
...
|---------|-------------|-------|
| [Redam Government](../factions/redam_government.md) | Coalition partner — shield provider | Most important external relationship; Redam speaks for Mycenas in all diplomatic matters |
| [Xianyang Government](../factions/xyanyang_government.md) | Fellow coalition member | Mutual respect — both isolationist-leaning ex-colonies with shared MUD abandonment trauma |
| [Abyd Government](../factions/abyd_government.md) | Nominal coalition member | Limited engagement — Abyd's warlordism makes reliable partnership difficult |
| [Pergamos New Government](../factions/pergamos_new_government.md) | Sympathetic neighbor | Threatened to intervene on Pergamos's behalf during COP offensive |
| [COP](../institutions/council_of_peace.md) | Distrusted | Mycenas views the COP with suspicion — any outside authority is a potential MUD-like betrayer |
| [MUD / Synod](../species/human.md) | **Hostile** | MUD fleets met with outright hostility; Synod approach treated as insult |
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Unknown | Pre-intervention Pergamos financial services may have reached the starbase; post-intervention, no data |
| [Anfoil State](../factions/anfoil_state.md) | Philosophical parallel | Both meritocratic isolationist states; no known direct relations |
...
|------|---------|------|--------|
| **Virel the Serene** | [Human](../species/human.md) (formerly MUD) | Founder and sovereign of Mycenas — meritocratic governor, HRZ artifact holder | Active — still ruling from inside the barrier |
...
> *"Mycenas remembers 80 years of screaming. They will never lower the barrier willingly. Which means the only question that matters is: what happens when the barrier lowers itself?"*
> — Redam intelligence assessment
