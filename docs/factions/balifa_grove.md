...
> *"You mine the bones of your mother and call it progress."*
> â€” **Arch Druidess Andreza Liora**, "The Verdant Flame"

| | |
|---|---|
| **Type** | [ECOS](../factions/earth_conscious_ontological_society.md) sub-faction / ecological extremists |
...
| **HQ** | The Superphoenix â€” titan-class bioship, orbiting Beluscos |
| **High Circle Seat** | Seat 2 â€” The Warden |
| **Alignment** | Radical preservationist / ecological supremacist |
| **Scale** | T2 â€” galaxy-wide ecological warfare capability |
| **Status** | Active â€” primary antagonist of galactic order |
...
During the [Convergence War](../history/convergence_war.md), MUD officer **Deacon Howard Dawn** ordered the C11 Bombardment â€” the destruction of an ECOS factory colony on [Abyd](../geography/sectors/abyd.md). A young girl named Andreza survived the bombardment. She should not have.

### Ashlara-3 â€” The Mercy That Made a Monster

When the surviving ECOS enclave reached Dawn's outpost at **Ashlara-3**, Dawn showed mercy. He granted them shelter.

Three days later, the survivors detonated a **terraforming bomb**. The blast destroyed the outpost and killed **millions**. Ashlara-3 was classified as the worst environmental failure in history â€” not a natural disaster, but a calculated act of reciprocal devastation.
...
> â€” **Deacon Howard Dawn**

### Rise to the Warden (~2580s—2620s)

Andreza climbed ECOS's internal hierarchy with a clarity of purpose that terrified moderates and inspired radicals. She formalized the **Mourning Cycle** â€” a systematic doctrine for ecological warfare â€” and built the Balifa Grove into ECOS's most feared arm.

Her ascent to the **High Circle** was inevitable. She holds **Seat 2 â€” The Warden** â€” representing the radical wing that advocates ecological supremacy and views civilizational collapse as "Iris's rightful rebalancing." Her presence on the High Circle creates permanent tension with the moderate wing led by **Orra Windraft** (The Mender, [Lumiro Grove](../factions/lumiro_grove.md)).
...
|-------|------|-------------|
| **1** | **Embassy** | Diplomatic offers of "sustainable coexistence." Genuine in form, strategically calculated in timing. The offer is designed to be refused â€” creating moral justification for what follows |
...
| **3** | **Mourning** | The planet is declared "spiritually dead" â€” its natural systems deemed too corrupted to save through reform. The Arch Druidess performs the Rite of Mourning, a public ceremony broadcast across ECOS channels |
| **4** | **Purification** | Full military assault. Terraforming warheads deployed. Forced biogenesis â€” aggressive organisms seeded throughout urban infrastructure. Spores that eat through hull plating. Vines that crack foundations. Bioengineered predators released into population centers |
...
**Target:** [Frenir](../geography/sectors/frenir.md), an industrial sector ravaged by the Convergence War and subsequent COP intervention.
...
**Retaliation:** ONI Commander **Seeikolobe Mineefastu**, stationed at Frenir during the attack, responded with devastating force â€” he **burned three worlds** to punish the Balifa Grove. The event deepened the cycle of violence between ONI and ECOS.

**Balifa's assessment:** They called it a success.

> *"Even Frenir, once a scar of war, now breathes again beneath Iris' gaze."*
> â€” **Martuce Breeze**
...
| Field | Detail |
|-------|--------|
| **Class** | Titan â€” biomechanical leviathan |
...
| **Builder** | [Fimbul ECOS](../factions/fimbul_ecos.md) division |
...
The Superphoenix is not just a warship â€” it is a **living organism**. Its photosynthetic hull regenerates battle damage. Its interior is a cathedral of vines and bioluminescent growth. Andreza conducts the Rite of Mourning from its bridge, broadcasting to ECOS channels galaxy-wide.

In the Chapter 2 Holosim scenario, the Superphoenix arrives as the **final engagement** â€” emerging from the High Risk Zone with the full Mourning Fleet.

---

## The Mourning Fleet

The Balifa Grove's military arm is small but unconventional â€” built around biological warfare platforms rather than conventional warships.
...
The fleet does not fight conventional battles. It does not hold territory through occupation. It **transforms** territory â€” making it uninhabitable for civilization and simultaneously ideal for aggressive biological growth.
...
| Name | Title | Role |
|------|-------|------|
| **Andreza Liora** | Arch Druidess â€” "The Verdant Flame," "Avatar of Beluscos" | Supreme leader. Convergence War survivor. ECOS High Circle Seat 2 (The Warden). Absolute authority over the Mourning Cycle |
| **Martuce Breeze** | Chief Bioengineer â€” "The Seedbinder" | The diplomatic face and scientific genius. Human-Mierese hybrid. Designed the Superphoenix's self-healing hull. The most reasonable voice in an unreasonable faction â€” which makes her the most dangerous |
| **General Thaena Corvax** | Military Commander â€” "The Rootbreaker" | Commands the Mourning Fleet. Declared a "Mourning War" when Martuce was captured. In the MUD Holosim campaign, she chose self-destruction over surrender â€” detonating her own ship and scattering spores: *"I'll see you in the vines, Deacon"* |

### The Dynamic

Andreza is the prophet. Martuce is the scientist. Corvax is the soldier.

Andreza provides the vision â€” the absolute conviction that civilization is a disease and that nature will inevitably reassert supremacy. Martuce provides the technology â€” the bioweapons, the self-healing ships, the organisms that make the Mourning Cycle possible. Corvax provides the execution â€” the willingness to fight and die for the cause.
...
The [Chapter 2 Holosim campaign](../history/chapter2_holosim_balifa_campaign.md) was constructed specifically to simulate the Balifa Grove threat. Holosim â€” the COP's strategic simulation AI â€” built the scenario to test whether faction leadership could prevent ECOS-driven civilizational collapse.

The simulation runs across three faction perspectives:

| Campaign | Companion | Theme |
|----------|-----------|-------|
| **MUD â€” "The Weight of Mercy"** | Deacon Howard Dawn | Guilt, mercy, and cycles of violence. Dawn created Andreza; can he stop her? |
| **ONI â€” "Fire and Soil"** | Commander Seeikolobe | Pragmatism vs. restraint. Seeikolobe wants to glass ECOS biodomes â€” is he right? |
| **Ustur â€” "The Path Unwritten"** | Nova.tchr | Dogma vs. discovery. Nova's spiritual crisis mirrors the campaign's ideological war |

Holosim's conclusion: the Balifa Grove threat is **severe but containable** â€” if, and only if, all three super-factions coordinate their response. Individually, none can stop Andreza.
...
|---------|--------------|
| [ECOS](../factions/earth_conscious_ontological_society.md) | Parent faction â€” Andreza holds High Circle Seat 2. Complicated: the radical wing that the moderates cannot control but cannot expel |
| [Cataclysm Zone](../geography/the_cataclysm.md) | Theological fixation â€” Balifa views the Cataclysm frontier as proof of nature's ultimate power |
