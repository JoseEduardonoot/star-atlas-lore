...
| **Species** | [Mierese](../species/mierese.md) — lavender-skinned, tentacle-headed, story-obsessed |
| **Leader** | **Volmik Vaor Scarka** — ONI leader + COP Ruling Secretary |
| **Homeworld** | [Neuno](../geography/sectors/neuno.md) — sentient living planet |
| **Religion** | The Grand Tale — oral tradition dedicated to freeing their imprisoned god **Onato** |
| **Key Institutions** | [Mierese Lore Keepers](../factions/mierese_lore_keepers.md) (cultural), [Hikibashi](../factions/hikibashi.md) (covert military) |
...
> *"Driven by Mierese prowess."*
> — ONI Consortium founding charter, describing the Mierese contribution
...
Within ONI, the Mierese provide what the Sogmians cannot (subtlety), what the Punaab cannot (espionage), and what the Photoli cannot (urgency). Where the [Sogmian Sovereignty](../factions/sogmian_sovereignty.md) brings honor and military discipline, the [Kingdom of Evernat](../factions/kingdom_of_evernat.md) brings wealth and craft, and [The Photoli](../factions/the_photoli.md) bring ancient wisdom, the Mierese bring **adaptability** — the ability to improvise, infiltrate, negotiate, and survive anything the galaxy throws at them.
...
> *"Upon death: tell Onato a new story. New story: paradise. No new story: stay and help crack the puzzle. No stories at all: you vanish."*
> — Mierese afterlife, simplified
...
The [Hikibashi](../factions/hikibashi.md) are the covert military arm: an elite unit of forty to sixty assassin-spies so skilled that their existence is **officially denied** at every level of Mierese government. They serve only the Mierese leader and answer to no other authority — not ONI, not the COP.
...
| **~2392** | Atheist Mierese found the [Kamec Democracy](../factions/kamec_democracy.md) in a separate sector — the first Mierese diaspora |
| **~2396** | Mierese dreams lead to the discovery of [Glowhaven](../geography/sectors/glowhaven.md) (MRZ-31) — later site of the Swamp Lords |
| **~2399** | Mierese begin exploring the dangerous [Coral Nebula](../geography/sectors/coral_nebula.md) (MRZ-18) |
...
|-------|----------|--------|
| **Mierese of Neuno** | [Neuno sector](../geography/sectors/neuno.md) | Core species-state. ONI members |
| **[Kamec Democracy](../factions/kamec_democracy.md)** | Kamec Sector | Atheist Mierese breakaway (~2392). Clone-based democracy. No Onato faith |
| **[Swamp Lords](../factions/swamp_lords.md)** | [Glowhaven](../geography/sectors/glowhaven.md) (MRZ-31) | Separatist Mierese guarding the **Onato Box** — a sacred artifact. Reject ONI authority but revere the Lore Keepers |
...
|---------|-------------|
| [ONI Consortium](../factions/oni.md) | Current presiding species — *"Driven by Mierese prowess."* Vaor Scarka represents ONI in the COP, but governs collaboratively with all four member species |
| [Sogmian Sovereignty](../factions/sogmian_sovereignty.md) | Deep alliance, constant friction. The Sogmians consider Mierese cowardly; the Mierese consider Sogmians suicidally proud. Both are correct. Both are inseparable |
| [Kingdom of Evernat](../factions/kingdom_of_evernat.md) | Commercial and practical partnership. Mierese prowess protects Punaab trade routes; Punaab wealth funds Mierese operations |
| [The Photoli](../factions/the_photoli.md) | Wary respect. The Hikibashi are the only institution in ONI that has noticed patterns in Photoli behavior — and filed reports about them |
| [COP](../factions/council_of_peace.md) | Currently presiding through Vaor Scarka as Ruling Secretary. His militarist approach — interventions in Frenir, Pergamos, and the Jorvik Fleet — has expanded COP's operational footprint into the MRZ. **MUD is next in rotation** |
| [Swamp Lords](../factions/swamp_lords.md) | Estranged kin. Separatist Mierese who reject ONI but preserve Onato faith. The Lore Keepers are the only bridge between the ONI establishment and its most defiant rejection |
| [Kamec Democracy](../factions/kamec_democracy.md) | Philosophical rift. Atheist Mierese who deny Onato's existence and govern through clone democracy. A living argument about what it means to be Mierese without the Grand Tale |
| [Jorvik](../factions/jorvik.md) | Primary adversary. Operation Silt compromised Jorvik leadership over a decade. Scarka's COP interdiction crushed their fleet movements using Hikibashi intelligence |
| [Frenir New Government](../factions/frenir_new_government.md) | Liberated by Scarka's COP incursion (~2624). Hikibashi operative [Dosk Scarka](../factions/hikibashi.md) is embedded undercover on the Transition Council, tracking escaped slaver warlords |
| [Slavers of Frenir](../factions/slavers_of_frenir.md) | Destroyed by COP forces under Scarka's command. The warlord class was erased in months — the swiftest military action in modern COP history |
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Hostile awareness. Hikibashi Riptide operative [Trill Yara](../factions/hikibashi.md) assassinated a Shadow Bank financier funding anti-Mierese movements. The only confirmed Hikibashi exposure in history |
| [Dark Photoli](../factions/dark_photoli.md) | Existential threat. Scarka personally authorizes and monitors operations against Dark Photoli — system-level beings that require coordination between the Hikibashi and the Sih Rihim |
| [Hanging Gardens](../factions/hanging_gardens_government.md) | Tense standoff. The Gardens' food monopoly makes them untouchable — destroying them would starve COP-aligned worlds. Scarka's MRZ ambitions stop at this border, for now |
| [Zenith Door / Chior](../geography/sectors/zenith_door.md) | Ideological clash. ONI Ustur faction leader Chior opposes Scarka's militarism from an Ustur pacifist tradition, creating cross-faction tension within the COP itself |
| [Order of Seasons](../factions/order_of_seasons.md) | Rival operations. Both factions work in assassination and intelligence. The Hikibashi considers the Order *"theatrically inefficient."* The Order considers the Hikibashi *"soulless"* |
| [Gate Garrison](../factions/gate_garrison.md) | Operational friction. Bounty hunters who occasionally stumble into Hikibashi operations — an annoyance both sides pretend doesn't happen |
| [Scriptorium of the Lumikir](../factions/scriptorium_of_the_lumikir.md) | Philosophical contrast, practical partnership. The Chroniclers cross-reference oral tradition with written archives — the galaxy's most significant example of complementary knowledge systems |
| [Heralds of Vignus](../factions/heralds_of_vignus.md) | Philosophical parallel. Both preserve oral/experiential tradition. United in the belief that truth requires a living vessel |
| [Merchant Princes of Denebula](../factions/merchant_princes_of_denebula.md) | Commercial presence — [Mevertrase](../species/mierese.md) joined Ayevat's cross-species finance kingdom as Mierese representative |
| [MUD](../factions/mud.md) | Cautious coexistence. MUD is next in COP rotation after Scarka — the transition represents the most significant power shift in a generation |
...
- [Mierese](../species/mierese.md) — Full species canon (biology, Grand Tale, naming, religion)

### Factions

- [Hikibashi](../factions/hikibashi.md) — Elite assassin-spy unit, Three Currents, The Drowning
- [Mierese Lore Keepers](../factions/mierese_lore_keepers.md) — Cultural custodians, Sealed Chapters, Resonance Halls, Ondara Valel
- [Swamp Lords](../factions/swamp_lords.md) — Separatist Mierese, Onato Box, Glowhaven
- [Kamec Democracy](../factions/kamec_democracy.md) — Atheist Mierese diaspora, clone-based government
- [Dark Photoli](../factions/dark_photoli.md) — Existential threat requiring Hikibashi/Sih Rihim coordination
- [Frenir New Government](../factions/frenir_new_government.md) — Liberated by Scarka's COP incursion, Dosk Scarka embedded
- [Slavers of Frenir](../factions/slavers_of_frenir.md) — Destroyed by COP forces under Scarka's command
- [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) — Trill Yara assassination, the only Hikibashi exposure
- [Hanging Gardens](../factions/hanging_gardens_government.md) — Food monopoly standoff limiting COP's MRZ ambitions
- [Scriptorium of the Lumikir](../factions/scriptorium_of_the_lumikir.md) — Chroniclers partnership (oral + written knowledge)
- [Heralds of Vignus](../factions/heralds_of_vignus.md) — Philosophical parallel (knowledge through art)
- [Order of Seasons](../factions/order_of_seasons.md) — Rival assassination/intelligence operations
- [Gate Garrison](../factions/gate_garrison.md) — Operational friction with bounty hunters
- [Merchant Princes of Denebula](../factions/merchant_princes_of_denebula.md) — Mevertrase as Mierese financial representative

### Institutions

- [Council of Peace](../factions/council_of_peace.md) — Scarka as Ruling Secretary, MRZ Incursion, Scarka vs Opos conflict

### Geography

- [Neuno](../geography/sectors/neuno.md) — Sentient homeworld, six regions, Resonance Halls
- [Glowhaven](../geography/sectors/glowhaven.md) — Swamp Lords territory (MRZ-31)
- [Frenir](../geography/sectors/frenir.md) — COP liberation, Hikibashi Frenir Eye operation
...
- [Convergence War](../history/convergence_war.md) — Mierese entry into ONI, *"hammered thin by ordinances they did not vote for"*
- [Eras of Star Atlas](../history/eras_of_star_atlas.md) — Scarka's timeline: born ~2454, Admiral ~2610, Secretary ~2621
- [Never Alone Campaign](../narratives/never_alone_campaign.md) — Scarka announces MRZ pause, political maneuvering

### Meta

- [Named Characters](../meta/named_characters.md) — Vaor Scarka, Ondara Valel, Dosk Scarka, Trill Yara, Mirsk Eko, Muumaan Jura, Selkora Scarka
- [Master Timeline](../meta/master_timeline.md) — Full Mierese/Scarka chronology
