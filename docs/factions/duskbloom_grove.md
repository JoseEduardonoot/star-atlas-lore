...
> *"Nature does not build to confuse. When a creature defies the logic of Iris, it is a wound — and we are the ones who stitch it closed."*
> — **Arch Druidess Yeva Thornwind**, The Sentinel

| | |
|---|---|
| **Type** | [ECOS](../factions/earth_conscious_ontological_society.md) sub-faction / biodefense / anomaly containment |
| **Species** | Multi-species ([Human](../species/human.md)-majority, [Sogmian](../species/sogmian.md) minority) |
| **Leader** | Arch Druidess **Yeva Thornwind** (former [Nimrod Tracker](../factions/nimrod_trackers.md), High Circle Seat 6) |
| **HQ** | Roothold Station — edge of [Everstorm](../geography/sectors/everstorm.md) (MRZ-25) |
| **High Circle Seat** | **The Sentinel** — biodefense, [Dark Photoli](../factions/dark_photoli.md) threat response |
| **Active Personnel** | ~150,000 (hunters, containment teams, bio-researchers, garrison troops) |
| **Theaters** | Everstorm (genesium creatures), [Harkend](../geography/sectors/harkend.md) (Living Factory automatons) |
...
> *"The difference between a Nimrod Tracker and a Duskbloom druidess? The Tracker hunts what evolution made. We hunt what something else made — and we burn it before it breeds."*
> — Yeva Thornwind

The **Duskbloom Grove** is [ECOS](../factions/earth_conscious_ontological_society.md)'s anomaly containment and biodefense force — an entire grove of the ECOS network dedicated to hunting, studying, and neutralizing creatures and phenomena that should not exist. Born from the Everstorm crisis of ~2624, when [Dark Photoli](../factions/dark_photoli.md)-engineered monsters began terrorizing the storm-wracked settlements of MRZ-25, Duskbloom has since expanded its mandate to cover the [Living Factories](../factions/living_factories.md)' hostile automatons in [Harkend](../geography/sectors/harkend.md), uncontrolled mutations on the [Old Grove](../geography/sectors/old_grove.md) perimeter, and any other biological abomination that Galia produces.

Among the seven groves, Duskbloom is the most militaristic after [Balifa](../factions/balifa_grove.md) — but where Balifa wages ecological *war* on civilizations that destroy nature, Duskbloom wages ecological *defense* against creatures that corrupt it. They hunt monsters, not civilizations. This distinction matters: Duskbloom druidesses will work with anyone — [Nimrod Trackers](../factions/nimrod_trackers.md), [Relic Barons](../factions/relic_barons.md), even [Fimbul](../factions/fimbul_industries.md) engineers — if it means containing a threat before it spreads.
...
The Duskbloom Grove exists because something terrible was released into the [Everstorm](../geography/sectors/everstorm.md).
...
The source was eventually traced to a [Dark Photoli](../factions/dark_photoli.md) experiment. One of the five surviving Dark Photoli had discovered **genesium** — the bizarre bio-mechanical hybrid material from [Izar](../factions/izarians.md) worlds — and begun creating engineered predators using Dark Photoli essence as a catalyst. These **genesium spawn** were test subjects, released into the Everstorm as a proving ground, and then abandoned when the Dark Photoli moved on to other concerns.

The creatures didn't die when their creator left. They *bred*.

### ECOS Response

ECOS could not ignore the crisis. The Everstorm's ecosystem — already unique due to Iris-driven cosmic currents — was being corrupted from within. Iris-aligned natural organisms were being displaced or consumed by the genesium spawn. The [Hanging Gardens](../factions/hanging_gardens_government.md)' High Circle authorized the creation of a dedicated containment grove, and **Yeva Thornwind** — a former [Nimrod Tracker](../factions/nimrod_trackers.md) with decades of monster-hunting experience — was chosen to lead it.
...
The grove's mandate expanded when ECOS analysts recognized that the [Living Factories](../factions/living_factories.md)' automatons in [Harkend](../geography/sectors/harkend.md) posed a parallel threat. Beyond the zones pacified by the [Relic Barons](../factions/relic_barons.md)' pacifier device, hostile constructs roam freely — mechanical life forms with retained security programming, rudimentary problem-solving, and an unsettling capacity for aggression.
...
The Harkend theater is smaller and better-defined than Everstorm — the automatons don't breed, don't adapt as rapidly, and the pacifier technology provides a fallback. But the philosophical implications are deeper: the [Living Factories](../factions/living_factories.md) are classified as truly alive. Does ECOS — an organization devoted to protecting life — fight intelligent machines? Yeva's answer has been characteristically blunt: *"If it kills settlers and won't negotiate, it's a pest. I don't care what it's made of."*
...
**Arch Druidess Yeva Thornwind** is the only member of the High Circle who did not rise through ECOS's traditional druidess training pipeline. She was a [Nimrod Tracker](../factions/nimrod_trackers.md) — a professional monster hunter — for over twenty years before ECOS recruited her to establish Duskbloom Grove. Her career with the Trackers included:

- Dozens of hunts across the MRZ's most dangerous biospheres
- Extensive experience with [Old Grove](../geography/sectors/old_grove.md) border mutations and exotic predator tactics
...
The protocol is effective against genesium spawn but less reliable against Living Factory constructs, which don't respond to biological agents. Harkend operations use a modified version — **Iron Bloom** — that substitutes EMP grenades, corrosive agents, and [Fimbul](../factions/fimbul_industries.md)-supplied disruptor technology for the bioweapon components.
...
[Harkend](../geography/sectors/harkend.md)'s automatons are a fundamentally different threat. The [Living Factory](../factions/living_factories.md) constructs are mechanical, not biological — which means Duskbloom's bioweapons are useless. Beyond the zones pacified by the [Relic Barons](../factions/relic_barons.md)' pacifier device, the constructs revert to hostile security protocols, attacking any biological life that enters their territory.
...
| **Ironjaw** | Apex predator | Red | Genesium exoskeleton nearly impervious to kinetic rounds — [Nimrod Trackers](../factions/nimrod_trackers.md) classify as Black-tier when encountered solo |
...
Yeva Thornwind is the living bridge between Duskbloom and the [Nimrod Trackers](../factions/nimrod_trackers.md). The Trackers — a DAC of professional monster hunters who operate from the [Communion](../geography/sectors/communion.md) sector — share Duskbloom's core mission: hunting dangerous creatures. But where Trackers operate in small teams (2-6) for individual contracts, Duskbloom deploys battalion-strength forces for systematic containment.
...
[Fimbul Industries](../factions/fimbul_industries.md) provides Duskbloom with specialized equipment: disruptor technology for Harkend automaton operations, storm-hardened sensor arrays for Everstorm deployment, and modular weapons platforms designed for rapid adaptation to evolving threats. In return, Duskbloom provides bio-research data on genesium — a material Fimbul engineers find technically fascinating and commercially promising.

### Relic Baron Coordination

In [Harkend](../geography/sectors/harkend.md), the [Relic Barons](../factions/relic_barons.md) and Duskbloom maintain a structured cooperation: the Barons advance the pacifier device's range, Duskbloom secures the newly accessible zones, and both share intelligence on automaton behavior patterns. The Barons want relics; Duskbloom wants containment. The goals align — for now.
...
|---------|-------------|
| [ECOS](../factions/earth_conscious_ontological_society.md) | Parent — Duskbloom is the defensive wing of the grove network |
| [Hanging Gardens](../factions/hanging_gardens_government.md) | The Verdant Root — Yeva holds Seat 6 (The Sentinel) on the High Circle |
| [Nimrod Trackers](../factions/nimrod_trackers.md) | Close ally — Yeva Thornwind (former Tracker) bridges both organizations; joint Everstorm operations |
| [Fimbul Industries](../factions/fimbul_industries.md) | Equipment supplier — storm-hardened tech, disruptors, modular weapons |
| [Relic Barons](../factions/relic_barons.md) | Harkend cooperation — Barons push pacifier range, Duskbloom secures cleared zones |
| [Balifa Grove](../factions/balifa_grove.md) | Respectful distance — both militaristic groves, but opposite doctrines (offense vs. defense) |
| [Ashroot Grove](../factions/ashroot_grove.md) | Operational ally — Ashroot handles Old Grove perimeter mutants; Duskbloom handles everything beyond |
| [Living Factories](../factions/living_factories.md) | Active opposition — deploys bioweapons and disruptors against hostile constructs in Harkend |
| [Dark Photoli](../factions/dark_photoli.md) | Existential adversary — the source of the genesium spawn that created Duskbloom's reason to exist |
| [Iris Academy](../factions/iris_academy.md) | Research partner — shared xenobiological data, particularly on genesium spawn taxonomy |
...
|------|---------|------|-------|
| **Arch Druidess Yeva Thornwind** | [Human](../species/human.md) | Leader — High Circle Seat 6 (The Sentinel) | Former Nimrod Tracker, 20+ years monster-hunting experience, pragmatic theologian |
| **Warden Calyx Brenn** | [Human](../species/human.md) | Containment Corps Commander | Former Everstorm militia captain, survived the first spawn attacks in ~2624 |
| **Sentinel Gorvath 𐎃 Exinade** | [Sogmian](../species/sogmian.md) | Harkend Detachment Leader | Sogmian bioweapons specialist; adapted ECOS bio-agents for anti-construct use |
| **Adept Ryn Othala** | [Human](../species/human.md) | Bio-Research Wing Chief | Xenobiologist who formulated the hypothesis of "The Recursion" — the unconfirmed spawn hive intelligence |
| **Huntsworn Trikk Ghoss Eko** | [Mierese](../species/mierese.md) | Joint Operations Liaison (Nimrod Trackers) | Active Nimrod Warden who requested permanent Duskbloom assignment; Mierese olfactory senses invaluable for tracking genesium scent signatures |
