...
> *"In Kamec, every citizen is equal. The question is whether every citizen is original."*
> — Galactic political commentary

| | |
|---|---|
| **Type** | Clone democracy / hidden divergence crisis |
| **Species** | Multi-species (founded by atheist [Mierese](../species/mierese.md)) |
...
The **Kamec Democracy** — formally the **Democratic Order of Kamec** — is an MRZ state founded by **atheist [Mierese](../species/mierese.md)** who rejected their species' religious orthodoxy and established a multi-species haven where every citizen had a say and a vote. The name *"Kamec"* means *"equal"* in their founding dialect — a principle that attracted individuals from all species and factions fleeing recruitment and the looming [Convergence War](../history/convergence_war.md).
...
Kamec has rebuffed **ALL external inspection** of their system — including the [COP](../institutions/council_of_peace.md). Their defense: exactly **85.7623%** of their populace opposes external scrutiny.
...
|---------|--------------|
| [COP](../institutions/council_of_peace.md) | Watching closely — Kamec rebuffs ALL external inspection. The 85.7623% vote is suspicious |
| [Graft Research](../factions/graft_research.md) | **Suspected defector pipeline** — Kamec's legitimate cloning research may feed techniques to Graft's pseudonym network |
| [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) | Suspected refuge for Helix Genics fugitives |
| [Galia Medical Union](../factions/galia_medical_union.md) | Engaged on ethical implications of clone medicine |
| [Iris Academy](../factions/iris_academy.md) | Academic interest — Kamec's legal framework studied as precedent for AI and synthetic personhood |
| [Mierese](../species/mierese.md) species | Origin species — atheist Mierese founders contrast with mainstream Mierese religious culture |
...
- [Mierese](../species/mierese.md) — Founding species (atheist dissidents)

### Geography

- [Kamec Sector](../geography/sectors/kamec.md) — MRZ-29 sector lore document

### Factions

- [Graft Research](../factions/graft_research.md) — Cloning defector pipeline
- [Pergamos Shadow Banks](../factions/pergamos_shadow_banks.md) — Helix Genics fugitive harbor

### Institutions

- [Council of Peace](../institutions/council_of_peace.md) — External inspection rebuffed

### Meta

- [Named Characters](../meta/named_characters.md) — Reyna Vassik, Dovin Rath, Yael Sevrin
